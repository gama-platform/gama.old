...
public class AddDisplayLinkFeature extends AbstractAddFeature {
    ...
    public AddDisplayLinkFeature (IFeatureProvider fp) {
        super(fp);
    }
    ...
    public PictogramElement add(IAddContext context) {
        ...
        polyline.setForeground(manageColor(IColorConstant.LIGHT_GREEN));
    ...
    public boolean canAdd(IAddContext context) {
       ...
       if (context instanceof IAddConnectionContext
            && context.getNewObject() instanceof EDisplayLink) {
    		 return true;
        }
    	return false;
    }
