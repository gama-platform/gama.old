...
public class ImageObjectSWT extends AbstractObjectSWT {
	...
	public ImageObjectSWT(BufferedImage image, IAgent agent, double x, double y, double z, Double alpha, double width,
