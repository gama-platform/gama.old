...
public class StringObjectSWT extends AbstractObjectSWT {
	...
	public StringObjectSWT(String string, String font, Integer style, GamaPoint offset, GamaPoint scale, Color color,
