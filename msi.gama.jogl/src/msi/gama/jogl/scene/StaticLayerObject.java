 ...
 * 
 *
 * 'StaticLayerObject.java', in plugin 'msi.gama.jogl', is part of the source code of the 
...
public class StaticLayerObject extends LayerObject {
	...
	public static class WordLayerObject extends StaticLayerObject {
		...
		public void drawAxes(final double w, final double h) {
			...
			addGeometry(g, null, c, false, c, false, null, 0, 0, false, IShape.Type.LINESTRING, null);
			...
			addGeometry(g, null, Color.red, true, Color.red, false, null, 0, 0, false, IShape.Type.POLYGON, null);
			g =
