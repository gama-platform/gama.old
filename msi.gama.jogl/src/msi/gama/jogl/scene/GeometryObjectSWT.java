...
public class GeometryObjectSWT extends AbstractObjectSWT implements Cloneable {
	...
	public GeometryObjectSWT(Geometry geometry, IAgent agent, double z_layer, int layerId, Color color, Double alpha,
	...
	public void draw(ObjectDrawerSWT drawer, boolean picking) {
		if ( picking ) {
			JOGLSWTGLRenderer renderer = drawer.renderer;
