		...
		Runnable r = new Runnable() {
			...
			public void run() {
				...
				if ( dem.isInitialized() == true ) {
					...
					// addString("1:" + String.valueOf(size), size, size, 0.0d, 12, 12d, offset, scale, Color.black,
					// "Helvetica", 0,
					// 0, 1d);
					// // X Axis
					// addString("x", 1.2f * size, 0.0d, 0.0d, 12, 12d, offset, scale, Color.black, "Helvetica", 0, 0,
					// 1d);
					...
					// gl.glEnd();
					// // Y Axis
					// addString("y", 0.0d, 1.2f * size, 0.0d, 12, 12d, offset, scale, Color.black, "Helvetica", 0, 0,
					// 1d);
					// gl.glBegin(GL.GL_LINES);
					...
					// addString("z", 0.0d, 0.0d, 1.2f * size, 12, 12d, offset, scale, Color.black, "Helvetica", 0, 0,
					// 1d);
					// gl.glBegin(GL.GL_LINES);
