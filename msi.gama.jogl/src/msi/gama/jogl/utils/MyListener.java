...
public class MyListener implements KeyListener, MouseListener, MouseMotionListener, MouseWheelListener {
	...
	public void mouseWheelMoved(MouseWheelEvent arg0) {
		...
		// float incrementalZoomStep = (float) myCamera.getzPos() / 10;
		if ( arg0.getWheelRotation() < 0 ) {// Move Up
			myRenderer.displaySurface.zoomIn();

			// myCamera.setzPos(myCamera.getzPos() - incrementalZoomStep);
			// myCamera.setzLPos(myCamera.getzLPos() - incrementalZoomStep);
