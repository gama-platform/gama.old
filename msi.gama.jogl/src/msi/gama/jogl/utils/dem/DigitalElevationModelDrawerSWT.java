...
public class DigitalElevationModelDrawerSWT {

	static int terrain;
	private boolean initialized;
	private final JOGLSWTGLRenderer myGLRenderer;

	public DigitalElevationModelDrawerSWT(JOGLSWTGLRenderer glRenderer) {
	...
	public Texture loadTexture(String fileName) {
		...
		try {
			if ( myGLRenderer.getContext() != null ) {
				...
				throw new GamaRuntimeException(null);
			}
		} catch (Exception e) {
