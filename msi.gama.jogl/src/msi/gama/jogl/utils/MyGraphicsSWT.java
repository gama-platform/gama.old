...
public class MyGraphicsSWT {
	...
	public VertexArrayHandlerSWT vertexArrayHandler;
	...
	public MyGraphicsSWT(final JOGLSWTGLRenderer myGLRender) {
		...
		vertexArrayHandler = new VertexArrayHandlerSWT(gl, myGlu, myGLRender);
