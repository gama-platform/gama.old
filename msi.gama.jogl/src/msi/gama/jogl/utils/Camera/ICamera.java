 ...
 * 
 *
 * 'ICamera.java', in plugin 'msi.gama.jogl', is part of the source code of the 
...
public interface ICamera extends KeyListener, MouseListener, MouseMotionListener, MouseWheelListener {
	...
	public abstract boolean beginPicking(final GL gl);

	public abstract int endPicking(final GL gl);
