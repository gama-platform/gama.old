 ...
 * 
 *
 * 'VertexArrayHandler.java', in plugin 'msi.gama.jogl', is part of the source code of the 
...
public class VertexArrayHandler {
	...
	public void createVBOs() {
		...
		if ( indicesBufferTriangle.hasRemaining() ) {
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, nbVerticesTriangle * 3 * BufferUtil.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, nbVerticesTriangle * 4 * BufferUtil.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ELEMENT_ARRAY_BUFFER, nbVerticesTriangle * BufferUtil.SIZEOF_INT,
		...
		if ( IndicesBufferPolyContours.hasRemaining() ) {
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, nbVerticesContours * 3 * BufferUtil.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ELEMENT_ARRAY_BUFFER, nbVerticesContours * BufferUtil.SIZEOF_INT,
		...
		if ( facesIndicesBuffer.hasRemaining() ) {
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, nbVerticesFaces * 6 * BufferUtil.SIZEOF_FLOAT, vertexBufferQuads,
				GL.GL_STATIC_DRAW);
			myGl.glVertexPointer(3, GL.GL_FLOAT, 0, 0);
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, nbVerticesFaces * 6 * BufferUtil.SIZEOF_FLOAT, vertexBufferFacesN,
				GL.GL_STATIC_DRAW);
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, nbVerticesFaces * 7 * BufferUtil.SIZEOF_FLOAT, colorBufferQuads,
				GL.GL_STATIC_DRAW);
			myGl.glColorPointer(4, GL.GL_FLOAT, 0, 0);
			...
			myGl.glBufferData(GL.GL_ELEMENT_ARRAY_BUFFER, facesIndicesBuffer.capacity() * BufferUtil.SIZEOF_INT,
		...
		if ( facesContoursIndicesBuffer.hasRemaining() ) {
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, vertexBufferContours.capacity() * BufferUtil.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, colorBufferContours.capacity() * BufferUtil.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ELEMENT_ARRAY_BUFFER,
				facesContoursIndicesBuffer.capacity() * BufferUtil.SIZEOF_INT, facesContoursIndicesBuffer,
				GL.GL_STATIC_DRAW);
		...
		if ( indicesBufferLine.hasRemaining() ) {
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, vertexBufferLine.capacity() * BufferUtil.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, colorBufferLine.capacity() * BufferUtil.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ELEMENT_ARRAY_BUFFER, indicesBufferLine.capacity() * BufferUtil.SIZEOF_INT,
		...
		if ( planIndicesBuffer.hasRemaining() ) {
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, planVertexBuffer.capacity() * BufferUtil.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, planColorBuffer.capacity() * BufferUtil.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ELEMENT_ARRAY_BUFFER, planIndicesBuffer.capacity() * BufferUtil.SIZEOF_INT,
		...
		if ( planBorderIndicesBuffer.hasRemaining() ) {
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, planBorderBuffer.capacity() * BufferUtil.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, planBorderColorBuffer.capacity() * BufferUtil.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ELEMENT_ARRAY_BUFFER, planBorderIndicesBuffer.capacity() * BufferUtil.SIZEOF_INT,
		...
		if ( pointIndicesBuffer.hasRemaining() ) {
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, pointVertexBuffer.capacity() * BufferUtil.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, pointColorBuffer.capacity() * BufferUtil.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ELEMENT_ARRAY_BUFFER, pointIndicesBuffer.capacity() * BufferUtil.SIZEOF_INT,
		...
		if ( spheresIndicesBuffer.hasRemaining() ) {
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, spheresVertexBuffer.capacity() * BufferUtil.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, spheresNormalBuffer.capacity() * BufferUtil.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, spheresColorBuffer.capacity() * BufferUtil.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ELEMENT_ARRAY_BUFFER, spheresIndicesBuffer.capacity() * BufferUtil.SIZEOF_INT,
	...
	public void fillPolygonBufferUtil() {
		...
		indicesBufferTriangle = BufferUtil.newIntBuffer(nbVerticesTriangle);
	...
	public void fillFacesBufferUtil() {
		...
		facesIndicesBuffer = BufferUtil.newIntBuffer(nbVerticesFaces * 6);
	...
	public void fillFacesContoursBufferUtil() {
		...
		colorBufferContours = BufferUtil.newFloatBuffer(nbVerticesFaces * 8);

		facesContoursIndicesBuffer = BufferUtil.newIntBuffer(nbVerticesFaces * 8);
	...
	private void makeIcosphere(final int level) {
		...
		icosphereVertexBuffer = BufferUtil.newFloatBuffer(verts.size());
		for ( float x : verts ) {
			icosphereVertexBuffer.put(x);
		}
		icosphereVertexBuffer.rewind();
		icosphereIndexBuffer = BufferUtil.newIntBuffer(faceIndx.size());
		for ( int i : faceIndx ) {
