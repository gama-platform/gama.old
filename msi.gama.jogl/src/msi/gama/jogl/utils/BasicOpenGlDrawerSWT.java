...
public class BasicOpenGlDrawerSWT {
	...
	public JTSDrawerSWT myJTSDrawer;

	public BasicOpenGlDrawerSWT(final JOGLSWTGLRenderer gLRender) {

		gl = gLRender.gl;
		renderer = gLRender;

		myJTSDrawer = new JTSDrawerSWT(renderer);
