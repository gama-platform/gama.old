    ...
    public void displayChanged(GLAutoDrawable drawable, boolean modeChanged, boolean deviceChanged) {
        ...
        for(int i=0;i<6;i++){
                ...
                gl.glPushMatrix();
                    ...
                    if(index == i) gl.glColor3f(1,0,0);
                    else  gl.glColor3f(1,1,1);

                    switch(i){
                        case 0:glut.glutSolidCone(1, 1, 30, 30);break;
                        case 1:glut.glutSolidCube(1);break;
                        case 2:glut.glutSolidTorus(.2, 1, 30, 100);break;
                        case 3:glut.glutSolidTeapot(1);break;
                        case 4:glut.glutSolidRhombicDodecahedron();break;
                        case 5:glut.glutSolidSphere(1, 30, 30);break;
                    }
