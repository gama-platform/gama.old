/*******************************************************************************************************
 *
 * GamlFormatter.java, in msi.gama.lang.gaml, is part of the source code of the GAMA modeling and simulation platform
 * (v.1.9.3).
 *
...
public class GamlFormatter extends AbstractDeclarativeFormatter {
	...
	protected void configureFormatting(final FormattingConfig c) {
		...
		c.setLinewrap(2).after(g.getStandaloneModelAccess().getNameAssignment_2());
		...
		handled.add(g.getB_DisplayAccess().getLeftCurlyBracketKeyword_1());
		handled.add(g.getBlockAccess().getRightCurlyBracketKeyword_2_1());
		handled.add(g.getB_DisplayAccess().getRightCurlyBracketKeyword_3());
		...
		handleBlock(c, g.getB_DisplayAccess().getLeftCurlyBracketKeyword_1(),
				g.getB_DisplayAccess().getRightCurlyBracketKeyword_3(), 2);
