...
public class GamlGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class BuiltInElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cMatch_oneKeyword_1 = (Keyword)cAlternatives.eContents().get(1);
		private final Keyword cMatch_betweenKeyword_2 = (Keyword)cAlternatives.eContents().get(2);
		private final Keyword cCaptureKeyword_3 = (Keyword)cAlternatives.eContents().get(3);
		private final Keyword cReleaseKeyword_4 = (Keyword)cAlternatives.eContents().get(4);
		private final Keyword cAskKeyword_5 = (Keyword)cAlternatives.eContents().get(5);
		private final Keyword cSwitchKeyword_6 = (Keyword)cAlternatives.eContents().get(6);
		private final Keyword cCreateKeyword_7 = (Keyword)cAlternatives.eContents().get(7);
		private final Keyword cAddKeyword_8 = (Keyword)cAlternatives.eContents().get(8);
		private final Keyword cRemoveKeyword_9 = (Keyword)cAlternatives.eContents().get(9);
		private final Keyword cPutKeyword_10 = (Keyword)cAlternatives.eContents().get(10);
		...
		private final Keyword cReturnKeyword_13 = (Keyword)cAlternatives.eContents().get(13);
		
		/// **
		// * Built-in keywords (corresponding to special statements)
		// * / BuiltIn:
		//	"match" | "match_one" | "match_between" | "capture" | "release" | "ask" | "switch" | "create" | "add" | "remove" |
		//	"put" | "save" | "set" | "return";
		public ParserRule getRule() { return rule; }

		//"match" | "match_one" | "match_between" | "capture" | "release" | "ask" | "switch" | "create" | "add" | "remove" | "put"
		//| "save" | "set" | "return"
		public Alternatives getAlternatives() { return cAlternatives; }
		...
		//"match_one"
		public Keyword getMatch_oneKeyword_1() { return cMatch_oneKeyword_1; }

		//"match_between"
		public Keyword getMatch_betweenKeyword_2() { return cMatch_betweenKeyword_2; }
		...
		//"ask"
		public Keyword getAskKeyword_5() { return cAskKeyword_5; }

		//"switch"
		public Keyword getSwitchKeyword_6() { return cSwitchKeyword_6; }

		//"create"
		public Keyword getCreateKeyword_7() { return cCreateKeyword_7; }

		//"add"
		public Keyword getAddKeyword_8() { return cAddKeyword_8; }

		//"remove"
		public Keyword getRemoveKeyword_9() { return cRemoveKeyword_9; }

		//"put"
		public Keyword getPutKeyword_10() { return cPutKeyword_10; }
		...
		//"return"
		public Keyword getReturnKeyword_13() { return cReturnKeyword_13; }
	}
	...
	public class DefinitionFacetExprElements extends AbstractParserRuleElementFinder {
		...
		//DefinitionFacetExpr:
		//	ReturnsFacetExpr | NameFacetExpr;
		public ParserRule getRule() { return rule; }
	...
	public class PairExprElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		private final Group cGroup_1_0 = (Group)cGroup_1.eContents().get(0);
		private final Action cPairExprLeftAction_1_0_0 = (Action)cGroup_1_0.eContents().get(0);
		private final Assignment cOpAssignment_1_0_1 = (Assignment)cGroup_1_0.eContents().get(1);
		...
		public Action getPairExprLeftAction_1_0_0() { return cPairExprLeftAction_1_0_0; }
	...
	public class AdditionElements extends AbstractParserRuleElementFinder {
		...
		private final Action cExpressionLeftAction_1_0_1_0 = (Action)cGroup_1_0_1.eContents().get(0);
		...
		//(({Expression.left=current} op="+" | {Expression.left=current} op="-") right=Multiplication)*
		public Group getGroup_1() { return cGroup_1; }

		//{Expression.left=current} op="+" | {Expression.left=current} op="-"
		...
		//{Expression.left=current}
		public Action getExpressionLeftAction_1_0_1_0() { return cExpressionLeftAction_1_0_1_0; }
	...
	public class MultiplicationElements extends AbstractParserRuleElementFinder {
		...
		private final Action cExpressionLeftAction_1_0_2_0 = (Action)cGroup_1_0_2.eContents().get(0);
		private final Assignment cOpAssignment_1_0_2_1 = (Assignment)cGroup_1_0_2.eContents().get(1);
		private final Keyword cOpCircumflexAccentKeyword_1_0_2_1_0 = (Keyword)cOpAssignment_1_0_2_1.eContents().get(0);
		private final Assignment cRightAssignment_1_1 = (Assignment)cGroup_1.eContents().get(1);
		private final RuleCall cRightGamlBinaryExprParserRuleCall_1_1_0 = (RuleCall)cRightAssignment_1_1.eContents().get(0);
		
		//Multiplication returns Expression:
		//	GamlBinaryExpr (({Expression.left=current} op="*" | {Expression.left=current} op="/" | {Expression.left=current}
		//	op="^") right=GamlBinaryExpr)*;
		public ParserRule getRule() { return rule; }

		//GamlBinaryExpr (({Expression.left=current} op="*" | {Expression.left=current} op="/" | {Expression.left=current} op="^")
		...
		//(({Expression.left=current} op="*" | {Expression.left=current} op="/" | {Expression.left=current} op="^")
		//right=GamlBinaryExpr)*
		public Group getGroup_1() { return cGroup_1; }
		...
		//{Expression.left=current}
		public Action getExpressionLeftAction_1_0_2_0() { return cExpressionLeftAction_1_0_2_0; }

		//op="^"
		public Assignment getOpAssignment_1_0_2_1() { return cOpAssignment_1_0_2_1; }

		//"^"
		public Keyword getOpCircumflexAccentKeyword_1_0_2_1_0() { return cOpCircumflexAccentKeyword_1_0_2_1_0; }
