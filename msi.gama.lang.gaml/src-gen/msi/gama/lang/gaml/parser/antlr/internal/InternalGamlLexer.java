...
public class InternalGamlLexer extends Lexer {
    ...
    public final void mT__112() throws RecognitionException {
        try {
            int _type = T__112;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:109:8: ( 'camera:' )
            // InternalGaml.g:109:10: 'camera:'
            {
            match("camera:"); 
    ...
    public final void mRULE_KEYWORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:8166:14: ( ( 'each' | 'self' | 'myself' | 'nil' | 'super' ) )
            // InternalGaml.g:8166:16: ( 'each' | 'self' | 'myself' | 'nil' | 'super' )
            {
            // InternalGaml.g:8166:16: ( 'each' | 'self' | 'myself' | 'nil' | 'super' )
            int alt1=5;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_INTEGER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:8168:14: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) )
            // InternalGaml.g:8168:16: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            {
            // InternalGaml.g:8168:16: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalGaml.g:8168:21: '1' .. '9' ( '0' .. '9' )*
                    {
                    matchRange('1','9'); 
                    // InternalGaml.g:8168:30: ( '0' .. '9' )*
                    loop2:
                    do {
                        int alt2=2;
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:8170:14: ( ( 'true' | 'false' ) )
            // InternalGaml.g:8170:16: ( 'true' | 'false' )
            {
            // InternalGaml.g:8170:16: ( 'true' | 'false' )
            int alt4=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:8172:9: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '0' .. '9' )* )
            // InternalGaml.g:8172:11: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '0' .. '9' )*
            {
            ...
            // InternalGaml.g:8172:39: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '0' .. '9' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_DOUBLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:8174:13: ( ( '1' .. '9' ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '0' ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? ) )
            // InternalGaml.g:8174:15: ( '1' .. '9' ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '0' ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? )
            {
            // InternalGaml.g:8174:15: ( '1' .. '9' ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '0' ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? )
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // InternalGaml.g:8174:16: '1' .. '9' ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    {
                    matchRange('1','9'); 
                    // InternalGaml.g:8174:25: ( '0' .. '9' )*
                    loop6:
                    do {
                        int alt6=2;
                    ...
                    switch (alt8) {
                        case 1 :
                            // InternalGaml.g:8174:38: '.' ( '0' .. '9' )+
                            {
                            match('.'); 
                            // InternalGaml.g:8174:42: ( '0' .. '9' )+
                            int cnt7=0;
                            loop7:
                            do {
                                int alt7=2;
                    ...
                    // InternalGaml.g:8174:56: ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    int alt11=2;
                    ...
                    switch (alt11) {
                        case 1 :
                            // InternalGaml.g:8174:57: ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+
                            {
                    ...
                    break;
                case 2 :
                    // InternalGaml.g:8174:92: '0' ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    {
                    match('0'); 
                    // InternalGaml.g:8174:96: ( '.' ( '0' .. '9' )+ )?
                    int alt13=2;
                    ...
                    switch (alt13) {
                        case 1 :
                            // InternalGaml.g:8174:97: '.' ( '0' .. '9' )+
                            {
                            match('.'); 
                            // InternalGaml.g:8174:101: ( '0' .. '9' )+
                            int cnt12=0;
                            loop12:
                            do {
                                int alt12=2;
                    ...
                    // InternalGaml.g:8174:115: ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    int alt16=2;
                    ...
                    switch (alt16) {
                        case 1 :
                            // InternalGaml.g:8174:116: ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+
                            {
                            if ( input.LA(1)=='E'||input.LA(1)=='e' ) {
                                input.consume();
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:8176:13: ( ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalGaml.g:8176:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalGaml.g:8176:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt20=2;
            ...
            switch (alt20) {
                case 1 :
                    // InternalGaml.g:8176:16: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalGaml.g:8176:20: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop18:
                    do {
                        int alt18=3;
                        ...
                        switch (alt18) {
                    	case 1 :
                    	    // InternalGaml.g:8176:21: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    ...
                    break;
                case 2 :
                    // InternalGaml.g:8176:81: '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalGaml.g:8176:86: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop19:
                    do {
                        int alt19=3;
                        ...
                        switch (alt19) {
                    	case 1 :
                    	    // InternalGaml.g:8176:87: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    	    if ( input.LA(1)=='\''||input.LA(1)=='\\'||input.LA(1)=='b'||input.LA(1)=='f'||input.LA(1)=='n'||input.LA(1)=='r'||(input.LA(1)>='t' && input.LA(1)<='u') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:8178:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalGaml.g:8178:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalGaml.g:8178:24: ( options {greedy=false; } : . )*
            loop21:
            do {
                int alt21=2;
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:8184:16: ( . )
            // InternalGaml.g:8184:18: .
            {
            matchAny(); 
    ...
    static final String DFA26_eotS =
        "\1\uffff\1\66\1\73\3\66\1\uffff\1\66\1\uffff\10\66\1\153\2\uffff\1\66\3\uffff\10\66\1\u008a\1\u008c\1\uffff\1\u008f\1\uffff\1\u0092\1\u0094\1\u0097\6\uffff\2\u009e\1\uffff\2\64\2\uffff\1\66\2\uffff\1\u00a5\3\uffff\3\66\1\u00aa\1\66\1\u00ad\2\66\1\u00b6\5\66\1\