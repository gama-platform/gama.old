 ...
 * </p>
 * <ul>
 *   <li>{@link msi.gama.lang.gaml.gaml.impl.ParametersImpl#getParams <em>Params</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParametersImpl extends ExpressionImpl implements Parameters
{
  /**
  ...
  {
    return GamlPackage.Literals.PARAMETERS;
  }
  ...
  public void setParams(ExpressionList newParams)
  {
    if (newParams != params)
    {
      ...
      if (params != null)
        msgs = ((InternalEObject)params).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GamlPackage.PARAMETERS__PARAMS, null, msgs);
      if (newParams != null)
        msgs = ((InternalEObject)newParams).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GamlPackage.PARAMETERS__PARAMS, null, msgs);
      msgs = basicSetParams(newParams, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GamlPackage.PARAMETERS__PARAMS, newParams, newParams));
  }
