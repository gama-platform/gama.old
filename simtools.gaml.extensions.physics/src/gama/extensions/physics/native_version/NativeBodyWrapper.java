 ...
 */
public class NativeBodyWrapper implements IPhysicalConstants, IBody<PhysicsRigidBody, CollisionShape> {
	...
	public NativeBodyWrapper(final IAgent agent, final NativePhysicalWorldGateway gateway) {
		assert agent != null;
		this.agent = agent;
	...
	@Override
	public PhysicsRigidBody createAndInitializeBody(final CollisionShape shape) {
	...
	public Vector3f toVector(final GamaPoint v) {
