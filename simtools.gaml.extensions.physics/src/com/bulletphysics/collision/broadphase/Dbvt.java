...
public class Dbvt {
	...
	private static void split(final ObjectArrayList<Node> leaves, final ObjectArrayList<Node> left,
			final ObjectArrayList<Node> right, final Vector3f org, final Vector3f axis) {
		Vector3f tmp = VECTORS.get();
