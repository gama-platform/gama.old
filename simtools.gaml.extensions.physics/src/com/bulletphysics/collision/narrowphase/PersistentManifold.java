...
public class PersistentManifold {
	...
	public PersistentManifold(final Object body0, final Object body1, final int bla) {
		init(body0, body1, bla);
	}

	public void init(final Object body0, final Object body1, final int bla) {
		this.body0 = body0;
		this.body1 = body1;
		cachedPoints = 0;
		index1a = 0;
	...
	public void setBodies(final Object body0, final Object body1) {
		this.body0 = body0;
		this.body1 = body1;
	}
