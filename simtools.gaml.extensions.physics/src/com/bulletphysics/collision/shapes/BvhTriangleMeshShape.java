...
public class BvhTriangleMeshShape extends TriangleMeshShape {
	...
	public BvhTriangleMeshShape(final StridingMeshInterface meshInterface, final boolean useQuantizedAabbCompression) {
	 ...
	 */
	public BvhTriangleMeshShape(final StridingMeshInterface meshInterface, final boolean useQuantizedAabbCompression,
			final Vector3f bvhAabbMin, final Vector3f bvhAabbMax) {
	 ...
	 */
	public BvhTriangleMeshShape(final StridingMeshInterface meshInterface, final boolean useQuantizedAabbCompression,
			final Vector3f bvhAabbMin, final Vector3f bvhAabbMax, final boolean buildBvh) {
		super(meshInterface);
	...
	public void performRaycast(final TriangleCallback callback, final Vector3f raySource, final Vector3f rayTarget) {
	...
	public void performConvexcast(final TriangleCallback callback, final Vector3f raySource, final Vector3f rayTarget,
	 ...
	 */
	@Override
	public void processAllTriangles(final TriangleCallback callback, final Vector3f aabbMin, final Vector3f aabbMax) {
		// #ifdef DISABLE_BVH
