...
public class BulletGlobals {
	...
	public static void setContactAddedCallback(final ContactAddedCallback callback) {
	...
	public static void setContactDestroyedCallback(final ContactDestroyedCallback callback) {
	...
	public static void setContactProcessedCallback(final ContactProcessedCallback callback) {
