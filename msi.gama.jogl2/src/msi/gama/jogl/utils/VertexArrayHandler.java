...
public class VertexArrayHandler {
	...
	public void createVBOs() {
		...
		if ( indicesBufferTriangle.hasRemaining() ) {
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, nbVerticesTriangle * 3 * Buffers.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, nbVerticesTriangle * 4 * Buffers.SIZEOF_FLOAT,
		...
		if ( facesContoursIndicesBuffer.hasRemaining() ) {
			...
			myGl.glBufferData(GL.GL_ELEMENT_ARRAY_BUFFER,
				facesContoursIndicesBuffer.capacity() * Buffers.SIZEOF_INT, facesContoursIndicesBuffer,
				GL.GL_STATIC_DRAW);
		...
		if ( indicesBufferLine.hasRemaining() ) {
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, vertexBufferLine.capacity() * Buffers.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, colorBufferLine.capacity() * Buffers.SIZEOF_FLOAT,
		...
		if ( planIndicesBuffer.hasRemaining() ) {
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, planVertexBuffer.capacity() * Buffers.SIZEOF_FLOAT,
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, planColorBuffer.capacity() * Buffers.SIZEOF_FLOAT,
		...
		if ( planBorderIndicesBuffer.hasRemaining() ) {
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, planBorderBuffer.capacity() * Buffers.SIZEOF_FLOAT,
		...
		if ( pointIndicesBuffer.hasRemaining() ) {
			...
			myGl.glBufferData(GL.GL_ARRAY_BUFFER, pointColorBuffer.capacity() * Buffers.SIZEOF_FLOAT,
