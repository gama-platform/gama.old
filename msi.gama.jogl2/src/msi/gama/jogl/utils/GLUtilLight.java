...
public class GLUtilLight {
	 ...
	 * @param n_ofLight
	 */
	public static void createDiffuseLight(final GL2 gl, final float colors[], final float position[], final int n_ofLight) {
		switch (n_ofLight) {
		case 0: {
	...
	public static void DrawDiffuseLight0(float[] light0Position, final GL2 gl, final GLU glu, final double radius , Color diffuseLightValue) {
	...
	public static void UpdateDiffuseLightPosition(final GL2 gl, final GLU glu, float[] lightDiffusePos) {
