/**
 * Created by drogoul, 27 nov. 2011
 * 
 */
...
public class GraphTopology extends AbstractTopology {
	...
	public GamaPath pathBetween(final IGeometry source, final IGeometry target) {
		...
		if ( edgeS == edgeT ) {
			...
			Object nodeT = t1;
			try {
				GamaGeometry g1 = Cast.asGeometry(t1);
				GamaGeometry g2 = Cast.asGeometry(t2);
			...
			Object nodeS = s1;
			try {
				GamaGeometry g1 = Cast.asGeometry(s1);
				GamaGeometry g2 = Cast.asGeometry(s2);
