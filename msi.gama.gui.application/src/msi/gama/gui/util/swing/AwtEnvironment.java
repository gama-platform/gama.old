						...
						if ( c == 'p' ) {
							String command =
								GAMA.getExperiment().isPaused()
									? "msi.gama.gui.application.commands.PlaySimulation"
									: "msi.gama.gui.application.commands.PauseSimulation";
							...
							try {
								service.executeCommand(
									"msi.gama.gui.application.commands.StepByStepSimulation", null);
							} catch (Exception e1) {
								e1.printStackTrace();
							}
						} else if ( c == 'R' ) {
							try {
								service.executeCommand(
									"msi.gama.gui.application.commands.ReloadSimulation", null);
							} catch (Exception e1) {
								e1.printStackTrace();
							}
						}
