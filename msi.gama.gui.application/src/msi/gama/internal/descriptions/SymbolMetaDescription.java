 ...
 * 
 */
@facet(name = ISymbol.KEYWORD, type = IType.ID, optional = true)
public class SymbolMetaDescription {
	...
	public SymbolMetaDescription(final Class instantiationClass, final Class baseClass,
		...
		final boolean isRemoteContext) throws GamlException {
	...
	public void setInstantiationClass(final Class instantiationClass) throws GamlException {
