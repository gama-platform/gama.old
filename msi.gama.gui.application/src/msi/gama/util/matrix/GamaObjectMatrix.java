...
public class GamaObjectMatrix extends GamaMatrix<Object> {
	...
	public GamaObjectMatrix(final GamaPoint p) {
	...
	public GamaObjectMatrix(final List objects, final boolean flat, final GamaPoint preferredSize) {
	...
	@Override
	public boolean _removeAll(final IGamaContainer<?, Object> list) throws GamaRuntimeException {
