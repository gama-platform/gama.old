...
public class Cast {
	...
	public static IGeometry asGeometry(final IScope scope, final Object s)
		throws GamaRuntimeException {
		return (IGeometry) Types.get(IType.GEOMETRY).cast(scope, s);
	}

	public static IGeometry asGeometry(final Object val) throws GamaRuntimeException {
	...
	public static IGraph asGraph(final IScope scope, final Object val) throws GamaRuntimeException {
