 ...
 * 
 */
@symbol(name = ISymbol.SPECIES, kind = ISymbolKind.LAYER)
@inside(symbols = { ISymbol.DISPLAY, ISymbol.SPECIES })
...
//		TODO search for hostSpecies; may have several hostSpecies incase of micro-species are inherited
	...
	public String toString() {
		...
		return "SpeciesDisplayLayer species: " + this.getFacet(ISymbol.NAME).literalValue();
	}
}
