...
entities {
	...
	species ant skills: [ moving , visible ] control: fsm schedules: shuffle (
	list ( ant ) ) /*topology: circle(30) at_location {50,50} */ {
		...
		action drop {
			...
			set has_food var: has_food value: false ;
...
experiment Complete type: gui {
	parameter name: 'Number:' var: ants_number init: 400 unit: 'ants' category:
