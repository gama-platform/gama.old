/*******************************************************************************************************
 *
 * msi.gaml.extensions.fipa.FIPAContractNet.java, in plugin msi.gaml.extensions.fipa,
...
public class FIPAContractNet extends FIPAProtocol {
	...
	/** The __after_propose. */
	private static Object[] __after_propose = { FIPAConstants.Performatives.FAILURE,
			Integer.valueOf(FIPAConstants.CONVERSATION_END), INITIATOR, null, FIPAConstants.Performatives.CANCEL,
			Integer.valueOf(FIPAConstants.AGENT_ACTION_REQ), INITIATOR, __after_cancel,
			FIPAConstants.Performatives.ACCEPT_PROPOSAL, Integer.valueOf(FIPAConstants.AGENT_ACTION_REQ), INITIATOR,
	...
	private static Object[] __after_cfp =
			{ FIPAConstants.Performatives.FAILURE, Integer.valueOf(FIPAConstants.CONVERSATION_END), PARTICIPANT, null,
