 ...
 * 
 *
 * 'FIPAIteratedContractNet.java', in plugin 'msi.gaml.extensions.fipa', is part of the source code of the 
...
/**
 * Implementation of the FIPA Iterated Contract Net interaction protocol.
 * Reference : http://www.fipa.org/specs/fipa00030/SC00030H.html
 */
public class FIPAIteratedContractNet extends FIPAProtocol {
	...
	private static Object[] __after_propose = {
			...
			Integer.valueOf(FIPAConstants.AGENT_ACTION_REQ), INITIATOR, null,
			FIPAConstants.Performatives.CANCEL,
			Integer.valueOf(FIPAConstants.AGENT_ACTION_REQ), INITIATOR,
			__after_cancel };

	/** The __after_cfp. */
	private static Object[] __after_cfp = { FIPAConstants.Performatives.CANCEL,
			Integer.valueOf(FIPAConstants.AGENT_ACTION_REQ), INITIATOR,
