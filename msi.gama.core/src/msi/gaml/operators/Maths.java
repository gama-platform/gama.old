...
public class Maths {
	...
	@operator(value = { "^" }, can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	...
	@operator(value = { "^" }, can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {})
	@doc(value = "Returns the value (always a float) of the left operand raised to the power of the right operand.", usages = {
			@usage(value = "", examples = { @example(value = "4.84 ^ 0.5", equals = "2.2") }) })
	...
	@operator(value = "abs", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Returns the absolute value of the operand (so a positive int or float depending on the type of the operand).", masterDoc = true, usages = {
			@usage(value = "", examples = { @example(value = "abs (200 * -1 + 0.5)", equals = "199.5") }) })
	public static Double abs(final Double rv) {
		return rv < 0 ? -rv : rv;
	}

	@operator(value = "abs", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {})
	@doc(value = "Returns the absolute value of the operand (so a positive int or float depending on the type of the operand).", usages = {
			@usage(value = "", examples = { @example(value = "abs (-10)", equals = "10"),
					@example(value = "abs (10)", equals = "10"),
					@example(value = "abs (-0)", equals = "0", isTestOnly = true) }) })
	public static Integer abs(final Integer rv) {
		return (rv ^ rv >> 31) - (rv >> 31);
	}

	@operator(value = "acos", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Returns the value (in the interval [0,180], in decimal degrees) of the arccos of the operand (which should be in [-1,1]).", masterDoc = true, usages = {
			@usage(value = "if the right-hand operand is outside of the [-1,1] interval, returns NaN") }, examples = @example(value = "acos (0)", equals = "90.0"), see = {
					"asin", "atan", "cos" })
	...
	@operator(value = "asin", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Returns the value (in the interval [-90,90], in decimal degrees) of the arcsin of the operand (which should be in [-1,1]).", usages = {
			@usage(value = "if the right-hand operand is outside of the [-1,1] interval, returns NaN") }, examples = @example(value = "asin (0)", equals = "0.0"), see = {
					"acos", "atan", "sin" })
	...
	@operator(value = "atan", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Returns the value (in the interval [-90,90], in decimal degrees) of the arctan of the operand (which can be any real number).", masterDoc = true, examples = @example(value = "atan (1)", equals = "45.0"), see = {
			"acos", "asin", "tan" })
	...
	@operator(value = "tanh", can_be_const = true, concept = { IConcept.MATH, IConcept.ARITHMETIC })
	...
	@operator(value = "tanh", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {})
	...
	@operator(value = "cos_rad", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	...
	@operator(value = "sin_rad", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	...
	@operator(value = "tan_rad", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	...
	@operator(value = "cos", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Returns the value (in [-1,1]) of the cosinus of the operand (in decimal degrees).  The argument is casted to an int before being evaluated.", masterDoc = true, special_cases = "Operand values out of the range [0-359] are normalized.", see = {
			"sin", "tan" })
	...
	@operator(value = "sin", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Returns the value (in [-1,1]) of the sinus of the operand (in decimal degrees). The argument is casted to an int before being evaluated.", masterDoc = true, usages = @usage("Operand values out of the range [0-359] are normalized."), examples = {
			@example(value = "sin(360)", equals = "0.0") }, see = { "cos", "tan" })
	...
	@operator(value = "sin", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {})
	@doc(value = "the sinus of the operand (in decimal degrees).", examples = {
			@example(value = "sin (0)", equals = "0.0") })
	...
	@operator(value = "tan", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Returns the value (in [-1,1]) of the trigonometric tangent of the operand (in decimal degrees). The argument is casted to an int before being evaluated.", masterDoc = true, usages = {
			@usage(value = "Operand values out of the range [0-359] are normalized. Notice that tan(360) does not return 0.0 but -2.4492935982947064E-16"),
			@usage(value = "The tangent is only defined for any real number except 90 + k `*` 180 (k an positive or negative integer). Nevertheless notice that tan(90) returns 1.633123935319537E16 (whereas we could except infinity).") }, see = {
	...
	@doc(value = "Returns the value (in [-1,1]) of the trigonometric tangent of the operand (in decimal degrees). The argument is casted to an int before being evaluated.", examples = {
			@example(value = "tan (0)", equals = "0.0"), @example(value = "tan(90)", equals = "1.633123935319537E16") })
	public static Double tan(final Integer v) {
		final double rad = toRad * v;
		return FastMath.tan(rad);
	}

	@operator(value = "even", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	...
	@operator(value = "exp", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Returns Euler's number e raised to the power of the operand.", masterDoc = true, usages = @usage(value = "the operand is casted to a float before being evaluated."), examples = @example(value = "exp (0)", equals = "1.0"), see = "ln")
	...
	@operator(value = "fact", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Returns the factorial of the operand.", usages = @usage("if the operand is less than 0, fact returns 0."), examples = @example(value = "fact(4)", equals = "24"))
	...
	@operator(value = "ln", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = { IConcept.MATH,
			IConcept.ARITHMETIC })
	@doc(value = "Returns the natural logarithm (base e) of the operand.", masterDoc = true, usages = @usage(value = "an exception is raised if the operand is less than zero."), examples = @example(value = "ln(exp(1))", equals = "1.0"), see = "exp")
	...
	@operator(value = "ln", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {})
	@doc(value = "returns the natural logarithm (base e) of the operand.", examples = @example(value = "ln(1)", equals = "0.0"))
	...
	@operator(value = "-", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = { IConcept.MATH,
			IConcept.ARITHMETIC })
	...
	@operator(value = "round", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	...
	@operator(value = "sqrt", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Returns the square root of the operand.", masterDoc = true, usages = @usage(value = "if the operand is negative, an exception is raised"), examples = @example(value = "sqrt(4)", equals = "2.0"))
	public static Double sqrt(final IScope scope, final Integer v) throws GamaRuntimeException {
		if (v < 0) {
			throw GamaRuntimeException.warning("The sqrt operator cannot accept negative inputs", scope);
		}
	...
	public static Double sqrt(final Double v) throws GamaRuntimeException {
		if (v < 0) {
			throw GamaRuntimeException.warning("The sqrt operator cannot accept negative inputs");
		}
		return FastMath.sqrt(v);
	}

	@operator(value = IKeyword.DIVIDE, can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	...
	@operator(value = IKeyword.DIVIDE, can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {})
	@doc(value = "Returns a float, equal to the division of the left-hand operand by the right-hand operand.", see = "*")
	...
	@operator(value = IKeyword.MULTIPLY, can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Returns the product of the two operands.", masterDoc = true, usages = @usage(value = "if both operands are numbers (float or int), performs a normal arithmetic product and returns a float if one of them is a float.", examples = @example(value = "1 * 1", equals = "1")), see = {
			IKeyword.PLUS, IKeyword.MINUS, IKeyword.DIVIDE })
	public static Integer opTimes(final Integer a, final Integer b) {
		return a * b;
	}

	@operator(value = IKeyword.MULTIPLY, can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {})
	@doc(value = "Returns the product of the two operands", examples = {
			@example(value = "2.5 * 2", equals = "5.0") }, see = "/")
	...
	@operator(value = IKeyword.MULTIPLY, can_be_const = true, concept = {})
	@doc(value = "Returns the product of the two operands", examples = {}, see = "/")
	public static Double opTimes(final Integer a, final Double b) {
		return Double.valueOf(a * b);
	}

	@operator(value = IKeyword.MULTIPLY, can_be_const = true, content_type = ITypeProvider.SECOND_CONTENT_TYPE, category = {
			IOperatorCategory.ARITHMETIC }, concept = {})
	@doc(usages = {
			@usage(value = "if one operand is a matrix and the other a number (float or int), performs a normal arithmetic product of the number with each element of the matrix (results are float if the number is a float.", examples = {
	...
	@operator(value = IKeyword.MULTIPLY, can_be_const = true, content_type = ITypeProvider.FIRST_TYPE, category = {
			IOperatorCategory.ARITHMETIC }, concept = {})
	public static IMatrix opTimes(final Double a, final IMatrix b) {
		return b.times(a);
	}

	@operator(value = IKeyword.PLUS, can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Returns the sum, union or concatenation of the two operands.", masterDoc = true, usages = {
			@usage(value = "if both operands are numbers (float or int), performs a normal arithmetic sum and returns a float if one of them is a float.", examples = {
					@example(value = "1 + 1", equals = "2"), @example(value = "1.0 + 1", equals = "2.0"),
					@example(value = "1.0 + 2.5", equals = "3.5") }) }, see = { IKeyword.MINUS, IKeyword.MULTIPLY,
							IKeyword.DIVIDE })
	...
	@operator(value = IKeyword.PLUS, can_be_const = true, content_type = ITypeProvider.SECOND_CONTENT_TYPE, category = {
			IOperatorCategory.ARITHMETIC }, concept = {})
	@doc(usages = {
			@usage(value = "if one operand is a matrix and the other a number (float or int), performs a normal arithmetic sum of the number with each element of the matrix (results are float if the number is a float.", examples = {
					@example(value = "3.5 + matrix([[2,5],[3,4]])", equals = "matrix([[5.5,8.5],[6.5,7.5]])") }) })
	// TODO check update
	public static IMatrix opPlus(final Integer a, final IMatrix b) {
		return b.plus(a);
	}

	@operator(value = IKeyword.PLUS, can_be_const = true, content_type = ITypeProvider.FIRST_TYPE, category = {
			IOperatorCategory.ARITHMETIC }, concept = {})
	...
	@operator(value = IKeyword.MINUS, can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Returns the difference of the two operands.", masterDoc = true, usages = {
			@usage(value = "if both operands are numbers, performs a normal arithmetic difference and returns a float if one of them is a float.", examples = {
					@example(value = "1 - 1", equals = "0"), @example(value = "1.0 - 1", equals = "0.0"),
					@example(value = "3.7 - 1.2", equals = "2.5"),
					@example(value = "3 - 1.2", equals = "1.8") }) }, see = { IKeyword.PLUS, IKeyword.MULTIPLY,
							IKeyword.DIVIDE })
	...
	@operator(value = IKeyword.MINUS, can_be_const = true, content_type = ITypeProvider.SECOND_CONTENT_TYPE, category = {
			IOperatorCategory.ARITHMETIC }, concept = {})
	@doc(value = "the difference of the two operands", usages = {
			@usage(value = "if one operand is a matrix and the other a number (float or int), performs a normal arithmetic difference of the number with each element of the matrix (results are float if the number is a float.", examples = {
	...
	@operator(value = IKeyword.MINUS, can_be_const = true, content_type = ITypeProvider.FIRST_TYPE, category = {
			IOperatorCategory.ARITHMETIC }, concept = {})
	@doc(value = "the difference of the two operands")
	...
	@operator(value = "with_precision", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Rounds off the value of left-hand operand to the precision given by the value of right-hand operand", examples = {
			@example(value = "12345.78943 with_precision 2", equals = "12345.79"),
			@example(value = "123 with_precision 2", equals = "123.00") }, see = "round")
	...
	@operator(value = "floor", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Maps the operand to the largest previous following integer, i.e. the largest integer not greater than x.", examples = {
			@example(value = "floor(3)", equals = "3.0"), @example(value = "floor(3.5)", equals = "3.0"),
			@example(value = "floor(-4.7)", equals = "-5.0") }, see = { "ceil", "round" })
	public static final double floor(final double d) {
		return FastMath.floor(d);
	}

	@operator(value = "ceil", can_be_const = true, concept = { IConcept.MATH, IConcept.ARITHMETIC })
	...
	@operator(value = "mod", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Returns the remainder of the integer division of the left-hand operand by the right-hand operand.", usages = {
			@usage(value = "if operands are float, they are truncated"),
			@usage(value = "if the right-hand operand is equal to zero, raises an exception.") }, examples = {
					@example(value = "40 mod 3", equals = "1") }, see = "div")
	public static Integer opMod(final IScope scope, final Integer a, final Integer b) {
		return a % b;
	}

	@operator(value = "div", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Returns the truncation of the division of the left-hand operand by the right-hand operand.", masterDoc = true, usages = @usage(value = "if the right-hand operand is equal to zero, raises an exception."), examples = @example(value = "40 div 3", equals = "13"), see = "mod")
	...
	@operator(value = "div", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "an int, equal to the truncation of the division of the left-hand operand by the right-hand operand.", usages = @usage(value = "if the right-hand operand is equal to zero, raises an exception."), examples = @example(value = "40.5 div 3", equals = "13"), see = "mod")
	...
	@operator(value = "div", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {})
	@doc(value = "an int, equal to the truncation of the division of the left-hand operand by the right-hand operand.", usages = @usage(value = "if the right-hand operand is equal to zero, raises an exception."), examples = @example(value = "40 div 4.1", equals = "9"))
	...
	@operator(value = "div", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {})
	@doc(value = "an int, equal to the truncation of the division of the left-hand operand by the right-hand operand.", examples = @example(value = "40.1 div 4.5", equals = "8"))
	...
	@operator(value = "atan2", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	...
	@operator(value = "hypot", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	@doc(value = "Returns sqrt(x2 +y2) without intermediate overflow or underflow.", special_cases = "If either argument is infinite, then the result is positive infinity. If either argument is NaN and neither argument is infinite, then the result is NaN.", examples = @example(value = "hypot(0,1,0,1)", equals = "sqrt(2)"))
	...
	@operator(value = "is_number", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC, IConcept.TYPE })
	...
	@operator(value = "is_finite", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
	...
	@operator(value = "signum", can_be_const = true, category = { IOperatorCategory.ARITHMETIC }, concept = {
			IConcept.MATH, IConcept.ARITHMETIC })
