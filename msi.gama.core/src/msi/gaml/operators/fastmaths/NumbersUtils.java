/*********************************************************************************************
 *
 * 'NumbersUtils.java, in plugin msi.gama.core, is part of the source code of the GAMA modeling and simulation platform.
...
public final class NumbersUtils {
	 ...
	 */
	public static String toStringBits(final byte bits) {
	 ...
	 * @return String representation of specified bits, in big endian.
	 */
	public static String toStringBits(final short bits) {
	 ...
	 * @return String representation of specified bits, in big endian.
	 */
	public static String toStringBits(final int bits) {
	 ...
	 * @return String representation of specified bits, in big endian.
	 */
	public static String toStringBits(final long bits) {
	 ...
	 *            Last bit position (exclusive).
	 * @param bigEndian
	 *            True for bits to be added in big endian order (MSBit to LSBit) false for little endian order.
	 * @param padding
	 *            True if underscores must be added instead of out-of-range bits, false to just add characters
	 *            corresponding to in-range bits.
	 * @return String representation of specified bits.
	 */
	public static String toStringBits(final byte bits, final int firstBitPos, final int lastBitPosExcl,
			final boolean bigEndian, final boolean padding) {
	 ...
	 * @return String representation of specified bits.
	 */
	public static String toStringBits(final short bits, final int firstBitPos, final int lastBitPosExcl,
			final boolean bigEndian, final boolean padding) {
	 ...
	 * @return String representation of specified bits.
	 */
	public static String toStringBits(final int bits, final int firstBitPos, final int lastBitPosExcl,
			final boolean bigEndian, final boolean padding) {
	 ...
	 * @return String representation of specified bits.
	 */
	public static String toStringBits(final long bits, final int firstBitPos, final int lastBitPosExcl,
			final boolean bigEndian, final boolean padding) {
	 ...
	 *
	 * toStringCSN(double) and toStringNoCSN(double) could be made faster, by using directly internals of
	 * Double.toString(double), but this would require copy-paste of much tricky code from JDK, and the overhead of our
	 * little rework is relatively negligible.
	 */

	/**
	 * @param value
	 *            A double value.
	 * @return String representing the specified value, using "computerized scientific notation", which
	 *         Double.toString(double) uses for non-infinite values, when |value| < 1e-3 or |value| >= 1e7.
	 */
	public static String toStringCSN(final double value) {
		...
		if (abs >= NO_CSN_MIN_BOUND_INCL && abs < NO_CSN_MAX_BOUND_EXCL) {
			...
			if (abs >= 1.0) {
				/*
				 * 0123456 12.3456 ===> 1.23456E1 123.0 ===> 1.23E2
				 */
				...
				/*
				 * 012345678 0.0123456 ===> 1.23456E-2 0.01 ===> 1.0E-2
				 */
				int nonZeroIndex = 1;
