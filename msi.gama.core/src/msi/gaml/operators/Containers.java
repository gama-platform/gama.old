...
public class Containers {
	...
	public static IList last(final IScope scope, final Integer number, final IContainer l1) {
		IList result =
			new GamaList(Iterables.limit(Lists.reverse(nullCheck(scope, l1).listValue(scope, Types.NO_TYPE)),
				number < 0 ? 0 : number));
		return result;
	}
	...
	@doc(value = "the index of the first occurence of the right operand in the left operand container", usages = @usage("if the left operand is a map, index_of returns the index of a value or nil if the value is not mapped"), examples = { @example(value = "[1::2, 3::4, 5::6] index_of 4", equals = "3") })
	...
	@doc(value = "the index of the first occurence of the right operand in the left operand container", usages = @usage(value = "if the left operand is a matrix, index_of returns the index as a point", examples = { @example(value = "matrix([[1,2,3],[4,5,6]]) index_of 4", equals = "{1.0,0.0}") }))
	...
	@doc(value = "the index of the last occurence of the right operand in the left operand container", masterDoc = true, comment = "The definition of last_index_of and the type of the index depend on the container", usages = { @usage(value = "if the left operand is a list, last_index_of returns the index as an integer", examples = {
	...
	@doc(value = "the index of the last occurence of the right operand in the left operand container", usages = @usage(value = "if the left operand is a matrix, last_index_of returns the index as a point", examples = { @example(value = "matrix([[1,2,3],[4,5,4]]) last_index_of 4", equals = "{1.0,2.0}") }))
	...
	@doc(value = "returns a new list in which all the elements of the right operand have been removed from the left one", comment = "The behavior of the operator depends on the type of the operands.", usages = {
		...
		@usage(value = "if both operands are containers, returns a new list in which all the elements of the right operand have been removed from the left one", examples = {
			@example(value = "[1,2,3,4,5,6] - [2,4,9]", equals = "[1,3,5,6]"),
	...
	@doc(usages = { @usage(value = "if the right operand is an object of any type (except list), " + IKeyword.MINUS +
		...
		@example(value = "[1,2,3,4,5,6] - 2", equals = "[1,3,4,5,6]"),
	...
	public static GamaPair pair(final IScope scope, final Object a, final Object b) {
	...
	@doc(value = "returns a new list containing all the elements of both operands", usages = {
		...
		@example(value = "[1,2,3,4,5,6] + [2,4,9]", equals = "[1,2,3,4,5,6,2,4,9]"),
		@example(value = "[1,2,3,4,5,6] + [0,8]", equals = "[1,2,3,4,5,6,0,8]") }, see = { "" + IKeyword.MINUS })
	...
	public static IList among(final IScope scope, final Integer number, final IContainer c) throws GamaRuntimeException {
		...
		return new GamaList(Iterables.limit(scope.getRandom().shuffle(l), number < 0 ? 0 : number));
