...
public class Containers {
	...
	@operator(value = IKeyword.MINUS,
		...
		content_type = ITypeProvider.FIRST_CONTENT_TYPE,
		category = IOperatorCategory.CONTAINER)
	@doc(usages = { @usage(value = "if the left operand is a list and the right operand is an object of any type (except list), " +
		IKeyword.MINUS +
	...
	public static
		IList minus(final IScope scope, final IList l1, final Object object) {
	...
	public static
		IList minus(final IScope scope, final ISpecies l1, final IAgent object) {
	...
	usages = {
		...
		@usage(value = "if both operands are species, returns a special type of list called meta-population"),
			...
			@example(value = "[1,2,3,4,5,6] + [0,8]", returnType = "list<int>", equals = "[1,2,3,4,5,6,0,8]") }) },
			see = { "" + IKeyword.MINUS })
	public static
		IContainer plus(final IScope scope, final IContainer c1, final IContainer c2) {
	...
	@doc(usages = @usage(value = "if the right operand is an object of any type (except a container), " +
		IKeyword.PLUS + " returns a list of the elements of the left operand, to which this object has been added",
	...
	examples = {
			@example(value = "3 among [1,2,4,3,5,7,6,8]",
				...
				test = false), @example(value = "3 among g2", equals = "[node6,node11,node7]", isExecutable = false),
