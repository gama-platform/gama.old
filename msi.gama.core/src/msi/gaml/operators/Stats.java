...
public class Stats {
	...
	@operator(value = "R_compute",
		...
		category = { IOperatorCategory.STATISTICAL })
	@doc(value = "returns the value of the last left-hand operand of given R file (right-hand operand) in given vector  (left-hand operand).",
		examples = {
...
//		}
	...
	@operator(value = "R_compute_param",
		...
		index_type = IType.STRING,
		category = { IOperatorCategory.STATISTICAL })
	@doc(value = "returns the value of the last left-hand operand of given R file (right-hand operand) in given vector  (left-hand operand), R file (first right-hand operand) reads the vector (second right-hand operand) as the parameter vector",
