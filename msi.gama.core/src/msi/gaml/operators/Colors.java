...
public class Colors {
	...
	@operator(value = IKeyword.PLUS, can_be_const = true, category = { IOperatorCategory.COLOR }, concept = {IConcept.COLOR_OPERATOR} )
	...
	@operator(value = IKeyword.MINUS, can_be_const = true, category = { IOperatorCategory.COLOR }, concept = {IConcept.COLOR_OPERATOR} )
	...
	@operator(value = IKeyword.MULTIPLY, can_be_const = true, category = { IOperatorCategory.COLOR }, concept = {IConcept.COLOR_OPERATOR} )
	...
	@operator(value = IKeyword.DIVIDE, can_be_const = true, category = { IOperatorCategory.COLOR }, concept = {IConcept.COLOR_OPERATOR} )
	...
	@operator(value = "hsb", category = { IOperatorCategory.COLOR }, concept = {IConcept.COLOR_OPERATOR} )
	...
	@operator(value = "rgb", category = { IOperatorCategory.COLOR }, concept = {IConcept.COLOR_OPERATOR} )
	...
	@operator(value = "grayscale", category = { IOperatorCategory.COLOR }, concept = {IConcept.COLOR_OPERATOR} )
	...
	@operator(value = "rnd_color", category = { IOperatorCategory.COLOR }, concept = {IConcept.COLOR_OPERATOR} )
	@doc(value = "rgb color",
	...
	@operator(value = "blend", category = { IOperatorCategory.COLOR }, concept = {IConcept.COLOR_OPERATOR} )
	...
	@operator(value = "brewer_colors", category = { IOperatorCategory.COLOR }, concept = {IConcept.COLOR_OPERATOR} )
	...
	@operator(value = "brewer_colors", content_type = IType.COLOR, category = { IOperatorCategory.COLOR }, concept = {IConcept.COLOR_OPERATOR} )
	@doc(
	...
	@operator(value = "brewer_palettes", content_type = IType.COLOR, category = { IOperatorCategory.COLOR }, concept = {IConcept.COLOR_OPERATOR} )
	...
	@operator(value = "brewer_palettes", content_type = IType.STRING, category = { IOperatorCategory.COLOR }, concept = {IConcept.COLOR_OPERATOR} )
	@doc(value = "returns the list a palette with a given min number of classes and max number of classes)",
