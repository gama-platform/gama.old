/*********************************************************************************************
 *
 * 'Colors.java, in plugin msi.gama.core, is part of the source code of the GAMA modeling and simulation platform. (c)
...
public class Colors {
	 ...
	 *
	 * @example(value="rgb(\"red\",0.2)",equals="rgb([5,0,0])"), see = "hsb") public static GamaColor rgb(final IScope
	 * scope, final String s, final double a) { return GamaColorType.staticCast(scope, s, a); }
	 */
