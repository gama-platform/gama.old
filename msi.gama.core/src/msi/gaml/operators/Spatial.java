...
public abstract class Spatial {
	...
	public static abstract class Common {
		...
		@operator(value = "using", category = { IOperatorCategory.SPATIAL }, concept = { IConcept.TOPOLOGY,
				IConcept.SPATIAL_COMPUTATION }, type = ITypeProvider.FIRST_TYPE, content_type = ITypeProvider.FIRST_CONTENT_TYPE, index_type = ITypeProvider.FIRST_KEY_TYPE)
	...
	public static abstract class Creation {
		...
		@doc(value = "A circle geometry which radius is equal to the operand.", usages = {
				@usage(value = "returns a point if the operand is lower or equal to 0.") }, comment = "the center of the circle is by default the location of the current agent in which has been called this operator.", examples = {
		...
		@doc(value = "A circle geometry which radius is equal to the first operand, and the center has the location equal to the second operand.", usages = {
				@usage(value = "returns a point if the operand is lower or equal to 0.") }, examples = {
		...
		@operator(value = "arc", category = { IOperatorCategory.SPATIAL, IOperatorCategory.SHAPE }, concept = {
				IConcept.SHAPE, IConcept.GEOMETRY })
		@doc(value = "An arc, which radius is equal to the first operand, heading to the second and amplitude the third", usages = {
		...
		@doc(value = "A cross, which radius is equal to the first operand and the width of the lines for the second", examples = {
		...
		@operator(value = "arc", category = { IOperatorCategory.SPATIAL, IOperatorCategory.SHAPE }, concept = {})
		@doc(value = "An arc, which radius is equal to the first operand, heading to the second, amplitude to the third and a boolean indicating whether to return a linestring or a polygon to the fourth", usages = {
		...
		@operator(value = "cone", category = { IOperatorCategory.SPATIAL, IOperatorCategory.SHAPE }, concept = {
				IConcept.SHAPE, IConcept.GEOMETRY })
		@doc(value = "A cone geometry which min and max angles are given by the operands.", special_cases = {
		...
		@doc(value = "A square geometry which side size is equal to the operand.", usages = {
				@usage(value = "returns nil if the operand is nil.") }, comment = "the centre of the square is by default the location of the current agent in which has been called this operator.", examples = {
						@example(value = "square(10)", equals = "a geometry as a square of side size 10.", test = false) }, see = {
		...
		@operator(value = "rectangle", category = { IOperatorCategory.SPATIAL, IOperatorCategory.SHAPE }, concept = {
				IConcept.SHAPE, IConcept.GEOMETRY })
		@doc(value = "A rectangle geometry which side sizes are given by the operands.", masterDoc = true, usages = {
		...
		@operator(value = "rectangle", category = { IOperatorCategory.SPATIAL, IOperatorCategory.SHAPE }, concept = {})
		@doc(value = "A rectangle geometry which side sizes are given by the operands.", usages = {
				@usage(value = "returns nil if the operand is nil.") }, comment = "the center of the rectangle is by default the location of the current agent in which has been called this operator.", examples = {
						@example(value = "rectangle(10, 5)", equals = "a geometry as a rectangle with width = 10 and height = 5.", test = false) }, see = {
								"around", "circle", "cone", "line", "link", "norm", "point", "polygon", "polyline",
								"square", "triangle" })
		...
		@operator(value = "rectangle", category = { IOperatorCategory.SPATIAL, IOperatorCategory.SHAPE }, concept = {})
		@doc(value = "A rectangle geometry which upper-left and lower-right corners are defined as points.", usages = {
				@usage(value = "returns nil if the operand is nil.") }, examples = {
						@example(value = "rectangle({2.0,6.0}, {6.0,20.0})", equals = "a geometry as a rectangle with {2.0,6.0} as the upper-left corner, {6.0,20.0} as the lower-right corner.", test = false) }, see = {
								"around", "circle", "cone", "line", "link", "norm", "point", "polygon", "polyline",
								"square", "triangle" })
		...
		@doc(value = "A hexagon geometry which the given with and height", usages = {
				@usage("returns nil if the operand is nil.") }, comment = "the center of the hexagon is by default the location of the current agent in which has been called this operator.", examples = {
		...
		@doc(value = "A polygon geometry from the given list of points.", usages = {
				...
				@usage(value = "if the operand is composed of 2 points, returns a polyline geometry.") }, examples = {
						@example(value = "polygon([{0,0}, {0,10}, {10,10}, {10,0}])", equals = "a polygon geometry composed of the 4 points.", test = false) }, see = {
		...
		@operator(value = { "curve" }, expected_content_type = { IType.POINT, IType.GEOMETRY,
				IType.AGENT }, category = { IOperatorCategory.SPATIAL,
						IOperatorCategory.SHAPE }, concept = { IConcept.SHAPE, IConcept.GEOMETRY, IConcept.POINT })
		@doc(value = "A quadratic Bezier curve geometry built from the three given points composed of 10 points.", usages = {
				@usage(value = "if the operand is nil, returns nil") }, examples = {
		...
		@doc(value = "A quadratic Bezier curve geometry built from the three given points composed of a given numnber of points.", usages = {
				@usage(value = "if the operand is nil, returns nil"),
				@usage(value = "if the last operand (number of points) is inferior to 2, returns nil") }, examples = {
		...
		@doc(value = "A polyline geometry from the given list of points.", usages = {
				...
				@usage(value = "if the operand is composed of a single point, returns a point geometry.") }, examples = {
						@example(value = "polyline([{0,0}, {0,10}, {10,10}, {10,0}])", equals = "a polyline geometry composed of the 4 points.", test = false) }, see = {
								"around", "circle", "cone", "link", "norm", "point", "polygone", "rectangle", "square",
								"triangle" })
		 ...
		 * { Envelope3D env = new
		 * Envelope3D(GeometryUtils.computeEnvelopeFrom(scope, obj)); if (
		 * env.isNull() ) { env = new Envelope3D(0, 100, 0, 100, 0, 100); }
		 * final IShape shape = GamaGeometryType.buildBox(env.getWidth(),
		 * env.getHeight(), env.getDepth(), new GamaPoint(env.centre())); return
		 * shape; }
		 */
	...
	public static abstract class Operators {
		...
		@doc(value = "A geometry resulting from the intersection between the two geometries", special_cases = {
				"returns nil if one of the operands is nil" }, examples = {
						@example(value = "square(10) inter circle(5)", equals = "circle(5)") }, see = { "union", "+",
								"-" })
		...
		@operator(value = { "+", "union" }, category = { IOperatorCategory.SPATIAL }, concept = { IConcept.GEOMETRY,
				IConcept.SPATIAL_COMPUTATION })
		...
		@operator(value = { "union" }, expected_content_type = { IType.POINT, IType.GEOMETRY,
				IType.AGENT }, category = {
						IOperatorCategory.SPATIAL }, concept = { IConcept.GEOMETRY, IConcept.SPATIAL_COMPUTATION })
		@doc(usages = {
				@usage(value = "if the right-operand is a container of points, geometries or agents, returns the geometry resulting from the union all the geometries") }, examples = {
						@example(value = "union([geom1, geom2, geom3])", equals = "a geometry corresponding to union between geom1, geom2 and geom3", isExecutable = false) })
		...
		@operator(value = IKeyword.MINUS, category = { IOperatorCategory.SPATIAL }, concept = { IConcept.GEOMETRY,
				IConcept.SPATIAL_COMPUTATION })
		@doc(usages = @usage(value = "if both operands are a point, a geometry or an agent, returns the geometry resulting from the difference between both geometries", examples = @example(value = "geom1 - geom2", equals = "a geometry corresponding to difference between geom1 and geom2", isExecutable = false)))
		...
		@operator(value = IKeyword.MINUS, category = { IOperatorCategory.SPATIAL }, concept = { IConcept.GEOMETRY,
				IConcept.SPATIAL_COMPUTATION })
		@doc(usages = @usage(value = "if the right-operand is a list of points, geometries or agents, returns the geometry resulting from the difference between the left-geometry and all of the right-geometries", examples = @example(value = "rectangle(10,10) - [circle(2), square(2)]", equals = "rectangle(10,10) - (circle(2) + square(2))")))
		...
		public static IShape add_point(final IScope scope, final IShape g, final ILocation p) {
			...
			if (geometry instanceof Point) {
				...
				int id = -1;
				final Point pt = GeometryUtils.FACTORY.createPoint(point);
		...
		private static int indexClosestSegment(final Geometry geom, final Coordinate coord) {
			...
			for (int i = 0; i < geom.getCoordinates().length - 1; i++) {
				...
				final Geometry geom_Tmp = GeometryUtils.FACTORY.createLineString(coordinates);
			...
			if (geom.getCoordinates()[geom.getCoordinates().length - 1].equals(coord)) {
				return -1;
			}
			return index;
		}

		@operator(value = "masked_by", category = { IOperatorCategory.SPATIAL }, concept = { IConcept.GEOMETRY,
				IConcept.SPATIAL_COMPUTATION, IConcept.OBSTACLE })
		@doc(examples = {
		...
		@doc(value = "The two part of the left-operand lines split at the given right-operand point", usages = {
				@usage("if the left-operand is a point or a polygon, returns an empty list") }, examples = {
						@example(value = "polyline([{1,2},{4,6}]) split_at {7,6}", equals = "[polyline([{1.0,2.0},{7.0,6.0}]), polyline([{7.0,6.0},{4.0,6.0}])]") })
	...
	public static abstract class Transformations {
		...
		@operator(value = "rotated_by", category = { IOperatorCategory.SPATIAL,
				IOperatorCategory.SP_TRANSFORMATIONS }, concept = { IConcept.GEOMETRY, IConcept.SPATIAL_COMPUTATION,
						IConcept.SPATIAL_TRANSFORMATION })
		@doc(value = "A geometry resulting from the application of a rotation by the right-hand operand angles (degree) along the three axis (x,y,z) to the left-hand operand (geometry, agent, point)", masterDoc = true, examples = {
				@example(value = "rotated_by(pyramid(10),45, {1,0,0})", equals = "the geometry resulting from a 45 degrees rotation along the {1,0,0} vector to the geometry of the agent applying the operator.", test = false) }, see = {
						"transformed_by", "translated_by" })
		...
		/**
		 * @throws GamaRuntimeException
		 *             Apply a affinite operation (of a given coefficient and
		 *             angle)to the agent geometry. Angle is given by the
		 *             point.x ; Coefficient by the point.y
		 *
		 * @param args
		...
		@operator(value = "transformed_by", category = { IOperatorCategory.SPATIAL,
				IOperatorCategory.SP_TRANSFORMATIONS }, concept = { IConcept.GEOMETRY, IConcept.SPATIAL_COMPUTATION,
						IConcept.SPATIAL_TRANSFORMATION })
		@doc(value = "A geometry resulting from the application of a rotation and a scaling (right-operand : point {angle(degree), scale factor} of the left-hand operand (geometry, agent, point)", examples = {
				@example(value = "self transformed_by {45, 0.5}", equals = "the geometry resulting from 45 degrees rotation and 50% scaling of the geometry of the agent applying the operator.", test = false) }, see = {
		...
		/**
		 * @throws GamaRuntimeException
		 *             Apply a translation operation (vector (dx, dy)) to the
		 *             agent geometry
		 *
		 * @param args
		 *            : dx --: double; dy --: double
		...
		@doc(value = "A geometry corresponding to the operand geometry (geometry, agent, point) without its holes", examples = {
				@example(value = "solid(self)", equals = "the geometry corresponding to the geometry of the agent applying the operator without its holes.", test = false) })
		...
		@doc(value = "A list of geometries (triangles) corresponding to the Delaunay triangulation of the operand list of geometries", examples = {
				@example(value = "triangulate(self)", equals = "the list of geometries (triangles) corresponding to the Delaunay triangulation of the geometry of the agent applying the operator.", test = false) })
		...
		@operator(value = "voronoi", content_type = IType.GEOMETRY, category = { IOperatorCategory.SPATIAL,
				IOperatorCategory.SP_TRANSFORMATIONS }, concept = { IConcept.GEOMETRY, IConcept.SPATIAL_COMPUTATION,
						IConcept.SPATIAL_TRANSFORMATION })
		@doc(value = "A list of geometries corresponding to the Voronoi diagram built from the list of points", masterDoc = true, examples = {
		...
		@operator(value = "voronoi", content_type = IType.GEOMETRY, category = { IOperatorCategory.SPATIAL,
				IOperatorCategory.SP_TRANSFORMATIONS }, concept = {})
		@doc(value = "A list of geometries corresponding to the Voronoi diagram built from the list of points according to the given clip", masterDoc = true, examples = {
		...
		public static IList<IShape> toSquares(final IScope scope, final IShape geom, final Integer nbSquares,
			...
			return GeometryUtils.discretization(geom.getInnerGeometry(), nbSquares, overlaps, 0.99);
		}
		...
		public static IList<IShape> toSquares(final IScope scope, final IShape geom, final Integer nbSquares,
			...
			return GeometryUtils.discretization(geom.getInnerGeometry(), nbSquares, overlaps, precision);
		}

		@operator(value = "to_rectangles", content_type = IType.GEOMETRY, category = { IOperatorCategory.SPATIAL,
				IOperatorCategory.SP_TRANSFORMATIONS }, concept = { IConcept.GEOMETRY, IConcept.SPATIAL_COMPUTATION,
						IConcept.SPATIAL_TRANSFORMATION })
		@doc(value = "A list of rectangles of the size corresponding to the given dimension that result from the decomposition of the geometry into rectangles (geometry, dimension, overlaps), if overlaps = true, add the rectangles that overlap the border of the geometry", examples = {
		...
		@operator(value = { "split_geometry", "to_squares" }, content_type = IType.GEOMETRY, category = {
				IOperatorCategory.SPATIAL, IOperatorCategory.SP_TRANSFORMATIONS }, concept = { IConcept.GEOMETRY,
						IConcept.SPATIAL_COMPUTATION, IConcept.SPATIAL_TRANSFORMATION })
		@doc(value = "A list of geometries that result from the decomposition of the geometry by square cells of the given side size (geometry, size)", examples = {
		...
		@operator(value = "skeletonize", content_type = IType.GEOMETRY, category = { IOperatorCategory.SPATIAL,
				IOperatorCategory.SP_TRANSFORMATIONS }, concept = { IConcept.GEOMETRY, IConcept.SPATIAL_COMPUTATION,
						IConcept.SPATIAL_TRANSFORMATION })
		@doc(value = "A list of geometries (polylines) corresponding to the skeleton of the operand geometry (geometry, agent)", examples = {
	...
	public static abstract class Relations {
		...
		public static IPath path_between(final IScope scope, final ITopology graph, final IContainer<?, IShape> nodes)
			...
			if (n == 1) {
				return PathFactory.newInstance(scope.getTopology(), source, source,
	...
	public static abstract class Properties {
		...
		/**
		 * Return true if the agent geometry overlaps the geometry of the
		 * localized entity passed in parameter
		 *
		 * @param args
		...
		/**
		 * Return true if the agent geometry partially overlaps the geometry of
		 * the localized agent passed in parameter
		 *
		 * @param args
		 *            : agent --: a localized entity
		 *
		...
		/**
		 * Return true if the agent geometry touches the geometry of the
		 * localized entity passed in parameter
		 *
		 * @param args
		 *            : agent --: a localized entity
		...
		/**
		 * Return true if the agent geometry crosses the geometry of the
		 * localized entity passed in parameter
		 *
		 * @param args
		 *            : agent --: a localized entity
	...
	public static abstract class Punctal {
		...
		/**
		 * @throws GamaRuntimeException
		 *             determine the closest point of a geometry to another
		 *             given point.
		 *
		 * @param pt
		 *            a point
	...
	public static abstract class Queries {
		...
		public static IShape closest_to(final IScope scope, final IContainer<?, ? extends IShape> list,
			...
			} else if (list.getType().getContentType().isTranslatableInto(Types.GEOMETRY)) {
				return geomClostestTo(scope, list, source);
			}
			return null;
		}

		@operator(value = { "farthest_to" }, type = ITypeProvider.FIRST_CONTENT_TYPE, category = {
				IOperatorCategory.SPATIAL, IOperatorCategory.SP_QUERIES }, concept = { IConcept.GEOMETRY,
						IConcept.SPATIAL_COMPUTATION, IConcept.SPATIAL_RELATION, IConcept.AGENT_LOCATION })
	...
	public static abstract class Statistics {
		...
		@operator(value = { "simple_clustering_by_distance",
				"simple_clustering_by_envelope_distance" }, content_type = ITypeProvider.FIRST_TYPE, category = {
		...
		public static IList<IList<IAgent>> simpleClusteringByDistance(final IScope scope,
			...
			final IList<IList<IAgent>> groups = GamaListFactory
					.create(Types.LIST.of(agents.getType().getContentType()));
		...
		public static IList<IAgent> simpleClusteringByDistanceRec(final IScope scope, final IAgentFilter filter,
			...
			final List<IAgent> ags = new ArrayList<IAgent>(
		...
		@operator(value = { "hierarchical_clustering" }, content_type = ITypeProvider.FIRST_TYPE, category = {
				IOperatorCategory.SPATIAL, IOperatorCategory.SP_STATISTICAL,
				IOperatorCategory.STATISTICAL }, concept = { IConcept.GEOMETRY, IConcept.SPATIAL_COMPUTATION,
						IConcept.AGENT_LOCATION, IConcept.STATISTIC })
	...
	public static abstract class ThreeD {
		...
		@doc(value = "Sets the z ordinate of the n-th point of a geometry to the value provided by the third argument", masterDoc = true, examples = {
				@example("loop i from: 0 to: length(shape.points) - 1{" + "set shape <-  set_z (shape, i, 3.0);"
						+ "}") }, see = {})
		...
		@doc(value = "Sets the z ordinate of each point of a geometry to the value provided, in order, by the right argument", examples = {
				@example("shape <- triangle(3) set_z [5,10,14];") }, see = {})
		...
		@operator(value = "dem", category = { IOperatorCategory.SPATIAL, IOperatorCategory.THREED }, concept = {
				IConcept.GEOMETRY, IConcept.SPATIAL_COMPUTATION, IConcept.THREED, IConcept.TEXTURE })
		@doc(value = "A polygon that is equivalent to the surface of the texture", masterDoc = true, comment = "", examples = {
				@example(value = "dem(dem)", equals = "returns a geometry as a rectangle of width and height equal to the texture.", isExecutable = false) }, see = {})
		public static IShape dem(final IScope scope, final GamaFile demFileName) {
			return dem(scope, demFileName, demFileName, 1.0);
		}

		@operator(value = "dem", category = { IOperatorCategory.SPATIAL, IOperatorCategory.THREED }, concept = {})
		@doc(value = "A polygon equivalent to the surface of the texture", examples = {
				@example(value = "dem(dem,texture)", equals = "a geometry as a rectangle of weight and height equal to the texture.", isExecutable = false) }, see = {})
		...
		@operator(value = "dem", category = { IOperatorCategory.SPATIAL, IOperatorCategory.THREED }, concept = {})
		@doc(value = "A polygon that is equivalent to the surface of the texture", examples = {
				@example(value = "dem(dem,z_factor)", equals = "a geometry as a rectangle of weight and height equal to the texture.", isExecutable = false) }, see = {})
		...
		@operator(value = "dem", category = { IOperatorCategory.SPATIAL, IOperatorCategory.THREED }, concept = {})
		@doc(value = "A polygon equivalent to the surface of the texture", examples = {
				@example(value = "dem(dem,texture,z_factor)", equals = "a geometry as a rectangle of width and height equal to the texture.", isExecutable = false) }, see = {})
		public static IShape dem(final IScope scope, final GamaFile demFile, final GamaFile textureFile,
		...
		@doc(value = "A list of point corresponding to RGB value of an image (r:x , g:y, b:z)", examples = {
		...
		@operator(value = "is_clockwise", type = IType.BOOL, category = { IOperatorCategory.SPATIAL,
				IOperatorCategory.THREED }, concept = { IConcept.GEOMETRY, IConcept.SPATIAL_COMPUTATION,
						IConcept.THREED })
		@doc(value = "returns true if the geometry is defined clockwise ", examples = {
