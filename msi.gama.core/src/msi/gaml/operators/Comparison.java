...
public class Comparison {
	...
	@doc(value = "returns true the first integer operand is bigger than the second integer operand and smaller than the third integer operand", 
		examples = @example(value="between(5, 1, 10)",equals="true"), see = "")
	...
	@operator(value = GT, can_be_const = true,category={IOperatorCategory.COMPARISON})
	@doc(value = "true if the left-hand operand is greater than the right-hand operand, false otherwise.", masterDoc=true,
		usages = { @usage("if one of the operands is nil, returns false") }, examples = @example(value="3 > 7",equals="false"))
	...
	@operator(value = LT, can_be_const = true,category={IOperatorCategory.COMPARISON})
	@doc(value = "true if the left-hand operand is less than the right-hand operand, false otherwise.", masterDoc=true, 
		special_cases = { "if one of the operands is nil, returns false" }, examples = { @example(value="3 < 7",equals="true") })
	...
	@operator(value = LT, can_be_const = true,category={IOperatorCategory.COMPARISON})
	@doc(value = "true if the left-hand operand is less than the right-hand operand, false otherwise.", examples = { @example(value="3 < 2.5",equals="false") })
	...
	@operator(value = LT, can_be_const = true,category={IOperatorCategory.COMPARISON})
	@doc(value = "true if the left-hand operand is less than the right-hand operand, false otherwise.", examples = { @example(value="3.5 < 7",equals="true") })
	...
	@operator(value = LT, can_be_const = true,category={IOperatorCategory.COMPARISON})
	@doc(value = "true if the left-hand operand is less than the right-hand operand, false otherwise.", examples = { @example(value="3.5 < 7.6",equals="true") })
	public static Boolean less(final Double a, final Double b) {
		if ( a == null || b == null ) { return false; }
		return a < b;
	}

	@operator(value = GTE, can_be_const = true,category={IOperatorCategory.COMPARISON})
	@doc(value = "true if the left-hand operand is greater or equal than the right-hand operand, false otherwise.",  masterDoc=true,
	usages = { @usage("if one of the operands is nil, returns false") }, examples = { @example(value="3 >= 7",equals="false") })
	...
	@operator(value = GTE, can_be_const = true,category={IOperatorCategory.COMPARISON})
	@doc(value = "true if the left-hand operand is greater or equal than the right-hand operand, false otherwise.",examples = { @example(value="3 >= 2.5",equals="true") })
	...
	@operator(value = GTE, can_be_const = true,category={IOperatorCategory.COMPARISON})
	@doc(value = "true if the left-hand operand is greater or equal than the right-hand operand, false otherwise.",examples = { @example(value="3.5 >= 7",equals="false") })
	...
	@operator(value = GTE, can_be_const = true,category={IOperatorCategory.COMPARISON})
	@doc(value = "true if the left-hand operand is greater or equal than the right-hand operand, false otherwise.",examples = { @example(value="3.5 >= 3.5",equals="true") })
	...
	@doc(value = "true if the left-hand operand is less or equal than the right-hand operand, false otherwise.", masterDoc=true, 
		usages = { @usage("if one of the operands is nil, returns false") }, examples = { @example(value="3 <= 7",equals="true") })
	...
	@operator(value = LTE, can_be_const = true,category={IOperatorCategory.COMPARISON})
	@doc(value = "true if the left-hand operand is less or equal than the right-hand operand, false otherwise.", examples = { @example(value="3 <= 2.5",equals="false") })
	...
	@operator(value = LTE, can_be_const = true,category={IOperatorCategory.COMPARISON})
	@doc(value = "true if the left-hand operand is less or equal than the right-hand operand, false otherwise.", examples = { @example(value="7.0 <= 7",equals="true") })
	...
	@operator(value = LTE, can_be_const = true,category={IOperatorCategory.COMPARISON})
	@doc(value = "true if the left-hand operand is less or equal than the right-hand operand, false otherwise.", examples = { @example(value="3.5 <= 3.5",equals="true") })
	...
	@doc(value = "returns true if both operands are equal, false otherwise", masterDoc=true, examples = { @example(value="3 = 3",equals="true"),
			@example(value="4.5 = 4.7",equals="false") }, see = { "!=" })
	...
	@operator(value = { "=" }, can_be_const = true,category={IOperatorCategory.COMPARISON})
	@doc(value = "returns true if both operands are equal, false otherwise", examples = { @example(value="3 = 3.0",equals="true"),
			@example(value="4 = 4.7",equals="false") }, see = { "!=" })
	...
	@operator(value = { "=" }, can_be_const = true,category={IOperatorCategory.COMPARISON})
	@doc(value = "returns true if both operands are equal, false otherwise", examples = { @example(value="3.0 = 3",equals="true"),
	...
	@operator(value = { "!=", "<>" }, can_be_const = true,category={IOperatorCategory.COMPARISON})
	@doc(value = "true if both operands are different, false otherwise", masterDoc=true, examples = { @example(value="4.5 = 4.7",equals="false") }, see = { "=" })
	...
	@operator(value = { "!=", "<>" }, can_be_const = true,category={IOperatorCategory.COMPARISON})
	@doc(value = " Returns false if the two operands are identical (i.e., the same object) or equal. Comparisons between nil values are permitted.", examples = {
			@example(value="[2,3] != [2,3]",equals="false"), @example(value="[2,4] != [2,3]",equals="true") })
	...
	@doc(value = "true if the left-hand operand is lower than the right-hand operand, false otherwise.",
		usages = { @usage(value="if both operands are points, returns true if only if left component (x) of the left operand if less than or equal to x of the right one and if the right component (y) of the left operand is greater than or equal to y of the right one.", examples = {
		@example(value="{5,7} < {4,6}",equals="false"), @example(value="{5,7} < {4,8}",equals="false")})})
	...
	@doc(value = "true if the left-hand operand is greater than the right-hand operand, false otherwise.",
		usages = { @usage(value="if both operands are points, returns true if only if left component (x) of the left operand if greater than x of the right one and if the right component (y) of the left operand is greater than y of the right one.", examples = {
		@example(value="{5,7} > {4,6}",equals="true"), @example(value="{5,7} > {4,8}",equals="false") })})
	...
	@doc(value = "true if the left-hand operand is greater or equals than the right-hand operand, false otherwise.",
		usages = { @usage(value="if both operands are points, returns true if only if left component (x) of the left operand if greater than or equal to x of the right one and if the right component (y) of the left operand is greater than or equal to y of the right one.", examples = {
		@example(value="{5,7} >= {4,6}",equals="true"), @example(value="{5,7} >= {4,8}",equals="false") })})
