...
public class Cast {
	...
	@operator(value = { IKeyword.IS }, category = { IOperatorCategory.CASTING }, concept = {IConcept.CAST, IConcept.TYPE} )
	...
	@operator(value = IKeyword.TOPOLOGY, content_type = IType.GEOMETRY, category = { IOperatorCategory.CASTING }, concept = {IConcept.CAST,IConcept.TOPOLOGY})
	...
	@operator(value = "as_int", can_be_const = true, category = { IOperatorCategory.CASTING }, concept = {IConcept.CAST})
	...
	@operator(value = "list_with", content_type = ITypeProvider.SECOND_TYPE, can_be_const = false, concept = {IConcept.CAST, IConcept.CONTAINER})
