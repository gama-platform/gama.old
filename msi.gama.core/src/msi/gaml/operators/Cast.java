...
public class Cast {
	...
	public static Boolean isA(final IScope scope, final IExpression a, final IExpression b)
		...
		// TODO Verify this method. And see if the treatment of species and types cannot be unified�
	...
	@doc(
		value = "casting of the operand to a container",
		special_cases = {
	...
	@doc(
		value = "casting of the operand to a graph.",
		special_cases = {
	...
	@doc(
		value = "casting of the operand to an agent (if a species name is used, casting to an instance of species name).",
		special_cases = {
	...
	@doc(
		value = "",
		special_cases = {
			"if the right-hand operand is nil, transforms the left-hand operand into an agentE",
			""},
		see = {"agent"})
	...
	@doc(
		value = "casting of the operand to a boolean value.",
		special_cases = {
	...
	@doc(
		value = "casting of the operand to a rgb color.",
		special_cases = {
	...
	@doc(
		value = "casting of the operand to a floating point value.",
		special_cases = {
	...
	@doc(
		value = "casting of the operand to an integer value.",
		special_cases =
	...
	@doc(
		value = "transforms the operand into a list",
		comment = "list always tries to cast the operand except if it is an int, a bool or a float; " +
