/*******************************************************************************************************
 *
 * msi.gaml.operators.Displays.java, in plugin msi.gama.core,
...
public class Displays {
	...
	// doc = @doc (""))
	//
	// public static GamaTree<String> layout(final IScope scope, final GamaMap<Object, Integer> map) {
	// if (map != null) {
	// if (map.size() == 1) {
	...
	private static GamaNode<String> buildSashFromMap(final IScope scope, final String orientation,
			final GamaMap<Object, Integer> nodes) {
		if (nodes == null) { throw GamaRuntimeException.error("Nodes of a " + orientation + " layout cannot be nil",
				scope); }
