...
public class MulticriteriaAnalyzeOperator {
	...
	@doc (
			...
			special_cases = { "returns -1 is the list of candidates is nil or empty" },
			examples = { @example (
					value = "electre_DM([[1.0, 7.0],[4.0,2.0],[3.0, 3.0]], [[\"name\"::\"utility\", \"weight\" :: 2.0,\"p\"::0.5, \"q\"::0.0, \"s\"::1.0, \"maximize\" :: true],[\"name\"::\"price\", \"weight\" :: 1.0,\"p\"::0.5, \"q\"::0.0, \"s\"::1.0, \"maximize\" :: false]])",
					equals = "0") },
