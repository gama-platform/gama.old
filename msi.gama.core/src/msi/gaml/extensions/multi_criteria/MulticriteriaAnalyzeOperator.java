...
public class MulticriteriaAnalyzeOperator {
	...
	@doc (
			value = "The index of the best candidate according to a method based on the ELECTRE methods. "
					...
					+ "These two conditions must be true for validating the outranking assertion. More information about the ELECTRE methods can be found in [Figueira,  J., Mousseau, V., Roy, B.: ELECTRE Methods. In: Figueira, J., Greco, S., and Ehrgott, M., (Eds.), Multiple Criteria Decision Analysis: State of the Art Surveys, Springer, New York, 133--162 (2005)](http://www.springerlink.com/content/g367r44322876223/). "
	...
	@doc (
			value = "The index of the best candidate according to a method based on the Evidence theory. "
					...
					+ "is based on the work of Dempster ([Dempster A (1967) Upper and lower probabilities induced by multivalued mapping. Annals of Mathematical Statistics, vol.  38, pp. 325--339](http://projecteuclid.org/DPubS?service=UI&version=1.0&verb=Display&handle=euclid.aoms/1177698950)) on lower and upper probability distributions. "
					+ "The first operand is the list of candidates (a candidate is a list of criterion values); "
