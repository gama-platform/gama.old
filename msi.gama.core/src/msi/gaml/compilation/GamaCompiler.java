...
public class GamaCompiler {
	...
	public static IScheduledAction buildAction(final Object target, final String method) {
	...
	public static List<Class> collectImplementationClasses(final Class baseClass,
		...
		// GUI.debug("Implementation classes for " + baseClass.getSimpleName() + ": " + classes);
		return classes2;
	}
	...
	public static void registerBinaryOperator(final String keyword, final String mName,
		...
		if ( isStatic ) {
			...
			methodName = declClass.getCanonicalName() + IKeyword._DOT + methodName;
		} else {
			leftClass = declClass;
