/*******************************************************************************************************
 *
 * SyntacticSpeciesElement.java, in msi.gama.core, is part of the source code of the GAMA modeling and simulation
 * platform (v.1.9.3).
 *
...
public class SyntacticSpeciesElement extends SyntacticStructuralElement {
	 ...
	 * (non-Javadoc)
	 *
	 * @see msi.gaml.compilation.ast.AbstractSyntacticElement#visitSpecies(msi.gaml.compilation.ast.ISyntacticElement.
	 * SyntacticVisitor)
	 */
	@Override
