...
import msi.gama.lang.gaml.descript.IUpdateOnChange;
...
public class GamlCompilCallback implements IUpdateOnChange {
	...
	private final ISymbol symbol = null;
	...
	public void update(final String filePath, final Resource r) throws Exception {
		...
		// GuiUtils.debug("GAMA parsing & compile : " + filePath);
		// symbol = DescriptionFactory.getModelFactory().compileFile(filePath);
		...
		// if ( stm == null ) {
		// // GuiUtils.warn("null Statement in auto-compil exception !");
		// e.printStackTrace();
		// }
