...
@symbol(name = IKeyword.RETURN, kind = ISymbolKind.SINGLE_COMMAND)
@inside(symbols = IKeyword.ACTION, kinds = { ISymbolKind.BEHAVIOR, ISymbolKind.SEQUENCE_COMMAND })
@facets(value = { @facet(name = IKeyword.VALUE, type = IType.NONE_STR, optional = false) })
