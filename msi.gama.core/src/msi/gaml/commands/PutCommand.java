...
@symbol(name = IKeyword.PUT, kind = ISymbolKind.SINGLE_COMMAND)
...
public class PutCommand extends AbstractContainerCommand {
	...
	protected void apply(final IScope scope, final Object object, final Object position,
		...
		casted =
			listType == IType.FLOAT ? Cast.asFloat(scope, casted) : listType == IType.INT ? Cast.asInt(scope, casted) : casted;
		if ( whole ) {
