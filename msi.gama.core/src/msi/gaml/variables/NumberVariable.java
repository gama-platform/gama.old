...
@facets(value = {
	...
	@facet(name = IKeyword.INIT, type = { IType.INT, IType.FLOAT }, optional = true),
	@facet(name = IKeyword.VALUE, type = { IType.INT, IType.FLOAT }, optional = true, doc = @doc(value = "", deprecated = "Use 'update' instead")),
	@facet(name = IKeyword.UPDATE, type = { IType.INT, IType.FLOAT }, optional = true),
	@facet(name = IKeyword.FUNCTION, type = { IType.INT, IType.FLOAT }, optional = true),
	...
	@facet(name = IKeyword.MIN, type = { IType.INT, IType.FLOAT }, optional = true),
	@facet(name = IKeyword.MAX, type = { IType.INT, IType.FLOAT }, optional = true),
