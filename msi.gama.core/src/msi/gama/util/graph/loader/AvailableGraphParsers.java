 ...
 * 
 *
 * 'AvailableGraphParsers.java', in plugin 'msi.gama.core', is part of the source code of the 
...
public class AvailableGraphParsers {
	...
	private static final Map<String,Class<? extends IGraphParser>> name2parser = new HashMap<String, Class<? extends IGraphParser>>() {{
	...
	public static IGraphParser getLoader(String name) {
