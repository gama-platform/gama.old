...
public class Path extends ShapeElement {
	 ...
	 *
	 * StyleAttribute styleAttrib = getStyle("fill-rule"); String fillRule = (styleAttrib == null) ? "nonzero" :
	 * styleAttrib.getStringValue();
	 *
	 * String d = attrs.getValue("d"); path = buildPath(d, fillRule.equals("evenodd") ? GeneralPath.WIND_EVEN_ODD :
