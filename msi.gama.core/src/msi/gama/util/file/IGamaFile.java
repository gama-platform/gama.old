...
public interface IGamaFile<K, V> extends IContainer<K, V> {
	...
	@getter(var = IKeyword.EXISTS, initializer = true)
	public abstract Boolean exists();

	@getter(var = IKeyword.EXTENSION, initializer = true)
	public abstract String getExtension();

	@getter(var = IKeyword.NAME, initializer = true)
	public abstract String getName();

	@getter(var = IKeyword.PATH, initializer = true)
	public abstract String getPath();

	@getter(var = IKeyword.CONTENTS)
	public abstract IContainer getContents() throws GamaRuntimeException;

	@getter(var = IKeyword.ISFOLDER, initializer = true)
	public abstract Boolean isFolder();

	public abstract boolean isPgmFile();

	@getter(var = IKeyword.READABLE, initializer = true)
	public abstract Boolean isReadable();

	@getter(var = IKeyword.WRITABLE, initializer = true)
