...
/**
 * Some class implementations persist information and require notification to complete all output prior to being
 * released. In this case, clients of those classes should call the complete method.
 *
