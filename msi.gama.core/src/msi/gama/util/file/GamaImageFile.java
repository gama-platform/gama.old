			...
			if (e != null) {
				...
				if (geodataFile != null) {
					...
					try {
						...
						minCorner = (GamaPoint)  new GamaShape(pr.transform(minCorner.getInnerGeometry())).getLocation();
						maxCorner = (GamaPoint)  new GamaShape(pr.transform(maxCorner.getInnerGeometry())).getLocation();
