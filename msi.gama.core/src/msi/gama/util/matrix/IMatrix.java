...
public interface IMatrix<T> extends IModifiableContainer<ILocation, T, ILocation, T>, IAddressableContainer<ILocation, T, ILocation, T> {
	...
	@doc(value = "returns a list of the rows of the matrix, with each row as a list of elements",
		examples = { @example(value = "rows_list(matrix([[\"el11\",\"el12\",\"el13\"],[\"el21\",\"el22\",\"el23\"],[\"el31\",\"el32\",\"el33\"]]))",
	...
	@doc(value = "returns a list of the columns of the matrix, with each column as a list of elements",
		examples = { @example(value = "columns_list(matrix([[\"el11\",\"el12\",\"el13\"],[\"el21\",\"el22\",\"el23\"],[\"el31\",\"el32\",\"el33\"]]))",
	...
	@doc(value = "returns the row at a num_line (rigth-hand operand)",
		examples = { @example(value = "matrix([[\"el11\",\"el12\",\"el13\"],[\"el21\",\"el22\",\"el23\"],[\"el31\",\"el32\",\"el33\"]]) row_at 2",
	...
	@doc(value = "returns the column at a num_col (rigth-hand operand)",
		examples = { @example(value = "matrix([[\"el11\",\"el12\",\"el13\"],[\"el21\",\"el22\",\"el23\"],[\"el31\",\"el32\",\"el33\"]]) column_at 2",
	...
	@operator(value = IKeyword.APPEND_HORIZONTALLY,
		...
		category = { IOperatorCategory.MATRIX })
	@doc(value = "A matrix resulting from the concatenation of the rows of the two given matrices. If not both numerical or both object matrices, returns the first matrix.",
		masterDoc = true,
		examples = { @example(value = "matrix([[1.0,2.0],[3.0,4.0]]) append_horizontally matrix([[1,2],[3,4]])",
	...
	@operator(value = IKeyword.APPEND_VERTICALLY,
		content_type = ITypeProvider.BOTH,
		category = { IOperatorCategory.MATRIX })
	@doc(value = "A matrix resulting from the concatenation of the columns  of the two given matrices. If not both numerical or both object matrices, returns the first matrix.",
		masterDoc = true,
		examples = { @example(value = "matrix([[1,2],[3,4]]) append_vertically matrix([[1,2],[3,4]])",
