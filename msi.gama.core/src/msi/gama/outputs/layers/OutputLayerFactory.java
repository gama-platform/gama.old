...
public class OutputLayerFactory extends SymbolFactory {
	...
	public static IDisplayLayer createSpeciesLayer(final String title,
		final ISpecies species, final String aspect, final IDisplayLayerBox box)
		throws GamaRuntimeException {
		IDescription desc;
		try {
			desc =
	...
	public static IDisplayLayer createTextLayer(final String text)
		throws GamaRuntimeException {
