...
@symbol(name = "legends", kind = ISymbolKind.LAYER, with_sequence = true)
...
public class LegendLayerStatement extends AbstractLayerStatement {

	AspectStatement aspect;
	static int i;

	public LegendLayerStatement(final IDescription desc) throws GamaRuntimeException {
		super(desc);
		IDescription d = DescriptionFactory.create(IKeyword.ASPECT, desc, IKeyword.NAME, "legends" + i++);
	...
	public short getType() {
		return ILayerStatement.LEGENDS;
	}
