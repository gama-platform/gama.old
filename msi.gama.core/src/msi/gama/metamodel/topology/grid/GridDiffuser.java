...
public class GridDiffuser {
	 ...
	 */
	public GridDiffuser(final IShape[] agents, final GridNeighbourhood neighbourhood,
	...
	public void diffuseVariable(final String name, final double value, final short type,
		final double proportion, final double variation, final ILocation location,
		final double range) {
