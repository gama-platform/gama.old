...
public interface ISpatialIndex {
	...
	void allInEnvelope(IScope scope, final IShape source, final IEnvelope envelope, final IAgentFilter f,
			boolean contained, Set<IAgent> accumulator);

	void allAtDistance(IScope scope, IShape source, double dist, IAgentFilter f, Set<IAgent> accumulator);
