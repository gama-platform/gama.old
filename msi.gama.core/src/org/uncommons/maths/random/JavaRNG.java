...
/**
 * <p>
 * This is the default {@link Random JDK RNG} extended to implement the {@link RepeatableRNG}
 * interface (for consistency with the other RNGs in this package).
 * </p>
 * 
 * <p>
 * The {@link MersenneTwisterRNG} should be used in preference to this class because it is
 * statistically more random and performs slightly better.
 * </p>
 * 
 * @author Daniel Dyer
 */
