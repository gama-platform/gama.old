 ...
 * 
 *
 * 'SecureRandomSeedGenerator.java', in plugin 'msi.gama.core', is part of the source code of the 
 ...
 * 
 * <p>
 * The advantage of using SecureRandom for seeding but not as the primary RNG is that we can use it
 * to seed RNGs that are much faster than SecureRandom.
 * </p>
 * 
 * <p>
 * This is the only seeding strategy that is guaranteed to work on all platforms and therefore is
