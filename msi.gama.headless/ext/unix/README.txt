...
*(c) 2007-2013 UMI 209 UMMISCO IRD/UPMC & Partners                *
*******************************************************************
...
How to start GAMA in headless mode with java command line
    java -cp GAMA_JARS  -Xms512m -Xmx2048  org.eclipse.core.launcher.Main  -application msi.gama.headless.id4 XMLInputFile OutputDirectory
