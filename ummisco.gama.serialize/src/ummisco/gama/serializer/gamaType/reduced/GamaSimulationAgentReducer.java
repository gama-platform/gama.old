...
//	new2_model_model0 shape -- value : POLYGON ((0 100, 0 0, 100 0, 100 100, 0 100)) at location[50.0;50.0;0.0]
...
//	new2_model_model0 members -- value : msi.gama.metamodel.population.MetaPopulation@75a97f53
...
//	new2_model_model0 people -- value : Population of people
	...
	public GamaSimulationAgentReducer(SimulationAgent agt){
	...
	//	this.attributes = agt.getAttributes();	
		...
		for(IAgent agent : agt.getAgents(agt.getScope())) {			
