...
environment ;
entities {
	species estimation_cellula_automata skills: [situated, visible] {
		var id type: string ;
		...
		var color type: rgb value: (number_of_BPHs > 1000000)?rgb [0,0,0]:        ((number_of_BPHs > 750000)?rgb [20,0,0]:        ((number_of_BPHs > 500000)?rgb [38,0,0]:        ((number_of_BPHs > 250000)?rgb [58,0,0]:        ((number_of_BPHs > 100000)?rgb [76,0,0]:        ((number_of_BPHs > 75000)?rgb [96,0,0]:        ((number_of_BPHs > 50000)?rgb [102,0,0]:        ((number_of_BPHs > 25000)?rgb [130,0,0]:        ((number_of_BPHs > 10000)?rgb [160,0,0]:        ((number_of_BPHs > 7500)?rgb [208,0,0]:        ((number_of_BPHs > 5000)?rgb [178,0,0]:        ((number_of_BPHs > 2500)?rgb [255,7,7]:        ((number_of_BPHs > 1000)?rgb [255,37,37]:        ((number_of_BPHs > 750)?rgb [255,65,65]:        ((number_of_BPHs > 500)?rgb [255,93,93]:        ((number_of_BPHs > 250)?rgb [255,123,123]:        ((number_of_BPHs > 100)?rgb [255,151,151]:        ((number_of_BPHs > 75)?rgb [255,181,181]:        ((number_of_BPHs > 50)?rgb [255,209,209]:        ((number_of_BPHs > 25)?rgb [255,237,237]:rgb [255,255,255]))))))))))))))))))) ;
		action resetcolor {
		...
		action setcolor {
			set color value: (number_of_BPHs > 1000000)?rgb [0,0,0]:        ((number_of_BPHs > 750000)?rgb [20,0,0]:        ((number_of_BPHs > 500000)?rgb [38,0,0]:        ((number_of_BPHs > 250000)?rgb [58,0,0]:        ((number_of_BPHs > 100000)?rgb [76,0,0]:        ((number_of_BPHs > 75000)?rgb [96,0,0]:        ((number_of_BPHs > 50000)?rgb [102,0,0]:        ((number_of_BPHs > 25000)?rgb [130,0,0]:        ((number_of_BPHs > 10000)?rgb [160,0,0]:        ((number_of_BPHs > 7500)?rgb [208,0,0]:        ((number_of_BPHs > 5000)?rgb [178,0,0]:        ((number_of_BPHs > 2500)?rgb [255,7,7]:        ((number_of_BPHs > 1000)?rgb [255,37,37]:        ((number_of_BPHs > 750)?rgb [255,65,65]:        ((number_of_BPHs > 500)?rgb [255,93,93]:        ((number_of_BPHs > 250)?rgb [255,123,123]:        ((number_of_BPHs > 100)?rgb [255,151,151]:        ((number_of_BPHs > 75)?rgb [255,181,181]:        ((number_of_BPHs > 50)?rgb [255,209,209]:        ((number_of_BPHs > 25)?rgb [255,237,237]:rgb [255,255,255]))))))))))))))))))) ;
		}
