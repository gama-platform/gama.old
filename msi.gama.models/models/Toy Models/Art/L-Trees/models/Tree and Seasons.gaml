...
//		list<rgb> branch_color_list <- [rgb(97,73,52),rgb(90,139,140),rgb(90,139,140),rgb(90,139,140)];
	...
	species plant_seed parent: tree_part{
		...
		aspect default { 
			draw polygon([location+{env_size/2,0,-1},location+{0.5*env_size/2,0.86*env_size/2,-1},location+{-0.5*env_size/2,0.86*env_size/2,-1},location+{-env_size/2,0,-1},location+{-0.5*env_size/2,-0.86*env_size/2,-1},location+{0.5*env_size/2,-0.86*env_size/2,-1}]) color: season.ground_color border: season.ground_color;	
...
experiment L_Tri type: gui autorun: true { 
	...
	float seed <- 0.05387546426306633;
 	output { 
		display 'Arbre' type:opengl background: season.sky_color ambient_light:150 draw_env: false toolbar: true 
		camera_pos: {-57.3933,202.0369,246.4316} camera_look_pos: {77.3441,18.6326,67.1022} camera_up_vector: {0.3664,0.4988,0.7854}{
			species branch aspect: default;
	        species leaf aspect: default;
	        species trunk aspect: default;
	        species plant_seed aspect: default;
