...
global {
	...
	list images of: string <- [project_path + 'model_evacuation_fire/includes/images/exit.jpg',project_path + 'model_evacuation_fire/includes/images/exit1.jpg'];
	int reachToGoal <- 0;
	int died <-0;
...
entities {
	...
	species exit{
		...
		aspect base {
     	...
     	aspect image {
			draw image: images at 1 size:30 ;      
		}
	}
	species instruction {
		rgb color <- rgb('green');
