	...
	output {			
		display MODAVI type:opengl ambient_light: 10 diffuse_light:100 draw_env:false {
			graphics 'ReferenceModel'{
				draw "Reference model" at:{200,50,0} size:5 color: #black bitmap:false;
			}
			species node_agent aspect: real position:{100,0,0.01} ;
			
			graphics 'View1'{
				draw "Advanced view" at:{50,210,0} size:5 color: #black bitmap:false;
			}
			...
			graphics 'AbstractView'{
				draw "Abstract view/controller" at:{250,210,0} size:5 color: #black bitmap:false;
			}
