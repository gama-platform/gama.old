...
entities {
	species people  { 
		...
		aspect default { 
			draw shape: circle size: 1.0 color: rgb('blue'); 
		}
...
experiment schelling type: gui {	
	...
	parameter 'Distance of perception:' var: neighbours_distance 
				max: 10 min: 1 category: 'Population' ;
	parameter 'Desired percentage of similarity:' var: percent_similar_wanted 
				min: float(0) max: float(1) category: 'Population' ;	
