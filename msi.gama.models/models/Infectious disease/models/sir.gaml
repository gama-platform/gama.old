 ...
 *  seir
 *  Author: 
 *  Description: A compartmental SIR model based on Hethcote description
 */
...
environment width: 100 height: 100 {
        grid sir_grid width: 100 height: 100 {
                ...
                list neighbours of: sir_grid <- self neighbours_at 4;
...
entities {
        species Host skills: [moving] {
                ...
                int sic_count <- 0;
                var myPlace type: sir_grid function: {location as sir_grid};
