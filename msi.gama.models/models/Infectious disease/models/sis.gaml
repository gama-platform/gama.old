 ...
 *  sis
 *  Author: 
 *  Description: A compartmental SIS model 
 */
...
environment width: 100 height: 100 {
        grid sis_grid width: 100 height: 100 {
                var color type: rgb init: rgb('black');
                list neighbours of: sis_grid <- self neighbours_at 4;
...
entities {
        species Host skills: [moving] {
                ...
                int sic_count <- 0;
                var myPlace type: sis_grid function: {location as sis_grid};
