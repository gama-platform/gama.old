...
global {
	var colors type: list init: [color_1, color_2, color_3, color_4, color_5, color_6, color_7, color_8] of: rgb;
	...
	var percent_similar_wanted type: float init: 0.5 min: float(0) max: float(1) parameter: 'Desired percentage of similarity:' category: 'Population' ;
	...
	var all_places type: list init: []  of: agent ; 
