...
global {
	...
	file shape_file_bounds <- file('../includes/data/bounds.shp');
	...
	reflex play_sound when: (day_time = min_work_start) {
		if (day_time = min_work_start) {
			start_sound source: '../includes/sounds/start_work_sound.mp3';
		}
	}
}
entities {
...
experiment road_traffic_with_sound type: gui {
