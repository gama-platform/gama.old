...
global {
	...
	init {
		...
		{ 
			create species:locations from: list(self select [params:: PARAMS, select:: LOCATIONS]) with:[ id:: int("id_1"), custom_name:: "name_1", geo::geometry("geo")]{ set shape value: geo; }
		}
