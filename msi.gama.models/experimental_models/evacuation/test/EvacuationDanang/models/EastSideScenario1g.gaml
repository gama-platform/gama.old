...
entities {
	...
	species pedestrian parent: occupationagent skills: [driving]{
		...
		reflex move_with_vehicleGoto when: (target != nil){
			...
			do pedestrianGoto target: target.location on: the_graph speed: speed target_type: false returns: moving_status;
...
experiment EastSideScenario1g type: gui {
	output{
		/* *
