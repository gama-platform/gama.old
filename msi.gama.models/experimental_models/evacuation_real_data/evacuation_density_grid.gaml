...
//	file shape_file_road <- shapefile('demo_gis/MainRoads.shp');
	...
	float max_density <- 4 min: 1 max: 10 parameter: 'Max density (people per m2)' category: 'Pedestrian';
...
//	grid density_grid width: 658 height: 860 { // 565880 agents -> not enough memory!
		...
		rgb color value: empty(pedestrians) ? BLACK : BLUE depends_on: [pedestrians];
