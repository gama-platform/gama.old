...
global {
			...
			var POSTGRES type:map init: ['host'::'localhost','dbtype'::'Postgres','database'::'hydro','port'::'5432','user'::'postgres','passwd'::'tmt'];
...
entities {
	species toto skills: [ SQLSKILL ] {
		...
		reflex testConnection{
			...
			do action: write with: [message::"Connection to Postgres is "+self testConnection[ params::POSTGRES]];
