...
public class MAELIASkill extends Skill {
	...
	@action(name = "maeliaInterrogateDB")
	@args(names = { "request", "DBName" })
	...
	// @args({ "DBName", "csv", "" })
	// public void createDB(final IScope scope) throws GamaRuntimeException, ClassNotFoundException,
	// SQLException {
	//
	// String DBName = (String) scope.getArg("DBName", IType.STRING);
