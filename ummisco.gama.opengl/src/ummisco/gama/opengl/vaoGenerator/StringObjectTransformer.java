/*********************************************************************************************
 *
 * 'StringObjectTransformer.java, in plugin ummisco.gama.opengl, is part of the source code of the
...
class StringObjectTransformer extends AbstractTransformer {
	...
	private StringObjectTransformer(StringObjectTransformer obj) {
		loadManyFacedShape(obj);
	}
	
	public StringObjectTransformer(StringObject strObj, int[] textureIds, String[] texturePaths, TextMeshData textMeshData, boolean isTriangulation) {
		// for StringObject
