...
public class GLUtilLight {
	 ...
	 * @param n_ofLight
	 */
	// public static void createDiffuseLight(final GL2 gl, final float colors[],
	...
	// position, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT0, GLLightingFunc.GL_DIFFUSE, colors,
	// 0);
	...
	// position, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT1, GLLightingFunc.GL_DIFFUSE, colors,
	// 0);
	...
	// position, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT2, GLLightingFunc.GL_DIFFUSE, colors,
	// 0);
	// gl.glEnable(GLLightingFunc.GL_LIGHT2);
	// }
	// break;
	// case 3: {
	// gl.glLightfv(GLLightingFunc.GL_LIGHT3, GLLightingFunc.GL_POSITION,
	// position, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT3, GLLightingFunc.GL_DIFFUSE, colors,
	// 0);
	// gl.glEnable(GLLightingFunc.GL_LIGHT3);
	// }
	// break;
	// case 4: {
	// gl.glLightfv(GLLightingFunc.GL_LIGHT4, GLLightingFunc.GL_POSITION,
	// position, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT4, GLLightingFunc.GL_DIFFUSE, colors,
	// 0);
	// gl.glEnable(GLLightingFunc.GL_LIGHT4);
	// }
	// break;
	// case 5: {
	// gl.glLightfv(GLLightingFunc.GL_LIGHT5, GLLightingFunc.GL_POSITION,
	// position, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT5, GLLightingFunc.GL_DIFFUSE, colors,
	// 0);
	// gl.glEnable(GLLightingFunc.GL_LIGHT5);
	// }
	// break;
	// case 6: {
	// gl.glLightfv(GLLightingFunc.GL_LIGHT6, GLLightingFunc.GL_POSITION,
	// position, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT6, GLLightingFunc.GL_DIFFUSE, colors,
	// 0);
	// gl.glEnable(GLLightingFunc.GL_LIGHT6);
	// }
	// break;
	// case 7: {
	// gl.glLightfv(GLLightingFunc.GL_LIGHT7, GLLightingFunc.GL_POSITION,
	// position, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT7, GLLightingFunc.GL_DIFFUSE, colors,
	// 0);
	// gl.glEnable(GLLightingFunc.GL_LIGHT7);
	// }
	// break;
	// default:
	// System.out.println("Error:openGL has only 8 lights available, the first
	// id being light0.");
	// }
	//
	 ...
	 * @param n_ofLight
	 */
	// public static void createDiffuseLight(final GL2 gl, final int n_ofLight,
	// final float pos) {
	// final float colors[] = { 1, 1, 1, 1 };
	// final float position[] = { pos, pos, pos, 1 };
	//
	// switch (n_ofLight) {
	// case 0: {
	// gl.glLightfv(GLLightingFunc.GL_LIGHT0, GLLightingFunc.GL_POSITION,
	 ...
	 * @param gl
	 * @param isSoft
	 *            if is false then surfaces wont flash
	 * @param alfa
	 *            - determines black-white-shade color of light R=G=B=alfa
	 * @param size
	 *            takse vaules from 0 to 128 and determines size of flash when
	 *            soft body
	 */
	// public static void createSoftMaterial(final GL2 gl, final boolean isSoft,
	// float alfa, int size) {
	// if (isSoft) {
	// final float cooficientColor[] = { alfa, alfa, alfa, 1 };
	 ...
	 * @param n_ofLight
	 */
	// public static void createDirectionLight(final GL2 gl, final float
	// disp_color[], final float flash_color[],
	// final float position[], final float direction[], final float size, final
	// float alfa, final int n_ofLight) {
	// switch (n_ofLight) {
	// case 0: {
	// gl.glLightfv(GLLightingFunc.GL_LIGHT0, GLLightingFunc.GL_POSITION,
	// position, 0);
	...
	// flash_color, 0);
	//
	// gl.glLightfv(GLLightingFunc.GL_LIGHT0, GLLightingFunc.GL_SPOT_DIRECTION,
	// direction, 0);
	// gl.glLightf(GLLightingFunc.GL_LIGHT0, GLLightingFunc.GL_SPOT_CUTOFF,
	// size);
	// gl.glLightf(GLLightingFunc.GL_LIGHT0, GLLightingFunc.GL_SPOT_EXPONENT,
	// alfa);
	// gl.glEnable(GLLightingFunc.GL_LIGHT0);
	// }
	// break;
	...
	// flash_color, 0);
	//
	// gl.glLightfv(GLLightingFunc.GL_LIGHT1, GLLightingFunc.GL_SPOT_DIRECTION,
	// direction, 0);
	// gl.glLightf(GLLightingFunc.GL_LIGHT1, GLLightingFunc.GL_SPOT_CUTOFF,
	// size);
	// gl.glLightf(GLLightingFunc.GL_LIGHT1, GLLightingFunc.GL_SPOT_EXPONENT,
	// alfa);
	// gl.glEnable(GLLightingFunc.GL_LIGHT1);
	// }
	// break;
	...
	// flash_color, 0);
	//
	// gl.glLightfv(GLLightingFunc.GL_LIGHT2, GLLightingFunc.GL_SPOT_DIRECTION,
	// direction, 0);
	// gl.glLightf(GLLightingFunc.GL_LIGHT2, GLLightingFunc.GL_SPOT_CUTOFF,
	// size);
	// gl.glLightf(GLLightingFunc.GL_LIGHT2, GLLightingFunc.GL_SPOT_EXPONENT,
	// alfa);
	// gl.glEnable(GLLightingFunc.GL_LIGHT2);
	// }
	// break;
	...
	// gl.glLightfv(GLLightingFunc.GL_LIGHT3, GLLightingFunc.GL_POSITION,
	// position, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT3, GLLightingFunc.GL_DIFFUSE,
	// disp_color, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT3, GLLightingFunc.GL_SPECULAR,
	// flash_color, 0);
	//
	// gl.glLightfv(GLLightingFunc.GL_LIGHT3, GLLightingFunc.GL_SPOT_DIRECTION,
	// direction, 0);
	// gl.glLightf(GLLightingFunc.GL_LIGHT3, GLLightingFunc.GL_SPOT_CUTOFF,
	// size);
	// gl.glLightf(GLLightingFunc.GL_LIGHT3, GLLightingFunc.GL_SPOT_EXPONENT,
	// alfa);
	// gl.glEnable(GLLightingFunc.GL_LIGHT3);
	// }
	// break;
	...
	// gl.glLightfv(GLLightingFunc.GL_LIGHT4, GLLightingFunc.GL_POSITION,
	// position, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT4, GLLightingFunc.GL_DIFFUSE,
	// disp_color, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT4, GLLightingFunc.GL_SPECULAR,
	// flash_color, 0);
	//
	// gl.glLightfv(GLLightingFunc.GL_LIGHT4, GLLightingFunc.GL_SPOT_DIRECTION,
	// direction, 0);
	// gl.glLightf(GLLightingFunc.GL_LIGHT4, GLLightingFunc.GL_SPOT_CUTOFF,
	// size);
	// gl.glLightf(GLLightingFunc.GL_LIGHT4, GLLightingFunc.GL_SPOT_EXPONENT,
	// alfa);
	// gl.glEnable(GLLightingFunc.GL_LIGHT4);
	// }
	// break;
	...
	// gl.glLightfv(GLLightingFunc.GL_LIGHT5, GLLightingFunc.GL_POSITION,
	// position, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT5, GLLightingFunc.GL_DIFFUSE,
	// disp_color, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT5, GLLightingFunc.GL_SPECULAR,
	// flash_color, 0);
	//
	// gl.glLightfv(GLLightingFunc.GL_LIGHT5, GLLightingFunc.GL_SPOT_DIRECTION,
	// direction, 0);
	// gl.glLightf(GLLightingFunc.GL_LIGHT5, GLLightingFunc.GL_SPOT_CUTOFF,
	// size);
	// gl.glLightf(GLLightingFunc.GL_LIGHT5, GLLightingFunc.GL_SPOT_EXPONENT,
	// alfa);
	// gl.glEnable(GLLightingFunc.GL_LIGHT5);
	// }
	// break;
	...
	// gl.glLightfv(GLLightingFunc.GL_LIGHT6, GLLightingFunc.GL_POSITION,
	// position, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT6, GLLightingFunc.GL_DIFFUSE,
	// disp_color, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT6, GLLightingFunc.GL_SPECULAR,
	// flash_color, 0);
	//
	// gl.glLightfv(GLLightingFunc.GL_LIGHT6, GLLightingFunc.GL_SPOT_DIRECTION,
	// direction, 0);
	// gl.glLightf(GLLightingFunc.GL_LIGHT6, GLLightingFunc.GL_SPOT_CUTOFF,
	// size);
	// gl.glLightf(GLLightingFunc.GL_LIGHT6, GLLightingFunc.GL_SPOT_EXPONENT,
	// alfa);
	// gl.glEnable(GLLightingFunc.GL_LIGHT6);
	// }
	// break;
	...
	// gl.glLightfv(GLLightingFunc.GL_LIGHT7, GLLightingFunc.GL_POSITION,
	// position, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT7, GLLightingFunc.GL_DIFFUSE,
	// disp_color, 0);
	// gl.glLightfv(GLLightingFunc.GL_LIGHT7, GLLightingFunc.GL_SPECULAR,
	// flash_color, 0);
	//
	// gl.glLightfv(GLLightingFunc.GL_LIGHT7, GLLightingFunc.GL_SPOT_DIRECTION,
	// direction, 0);
	// gl.glLightf(GLLightingFunc.GL_LIGHT7, GLLightingFunc.GL_SPOT_CUTOFF,
	// size);
	// gl.glLightf(GLLightingFunc.GL_LIGHT7, GLLightingFunc.GL_SPOT_EXPONENT,
	// alfa);
	// gl.glEnable(GLLightingFunc.GL_LIGHT7);
	// }
	// break;
	// default:
	// System.out.println("Error:openGL has avialable only 8 lights, the first
	// id light0.");
	// }
	//
	// }// END LIGHT DIRECTION
	//
	/**
	 * A shorter version method which create DirectionalLight. Size of bundle
	 * light has 30, alfa is 1 and disp&flash color are white
	 * 
	 * @param gl
	 * @param position
	 * @param direction
	 ...
	 */
	// public static void createDirectionLight(final GL2 gl, final float
	// position[], final float direction[],
	// final int n_ofLight) {
	// final float disp_color[] = { 1, 1, 1, 1 };
	// final float flash_color[] = { 1, 1, 1, 1 };
	// final float size = 30;
	// final float alfa = 1;
	// switch (n_ofLight) {
	// case 0: {
