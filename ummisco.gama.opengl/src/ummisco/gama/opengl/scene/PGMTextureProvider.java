...
public class PGMTextureProvider implements TextureProvider, SupportsImageTypes {
	 ...
	 * @see com.jogamp.opengl.util.texture.spi.TextureProvider#newTextureData(com.jogamp.opengl.GLProfile, java.io.File, int, int, boolean, java.lang.String)
	 */
	@Override
	public TextureData newTextureData(final GLProfile glp, final File file, final int internalFormat,
		...
		GamaImageFile f = new GamaImageFile(scope, file.getAbsolutePath());
		if ( f.getExtension().equals("pgm") ) {
			BufferedImage image = f.getImage(scope);
	...
	/**
	 * Method newTextureData()
	 * @see com.jogamp.opengl.util.texture.spi.TextureProvider#newTextureData(com.jogamp.opengl.GLProfile, java.io.InputStream, int, int, boolean, java.lang.String)
	 */
	@Override
	...
	/**
	 * Method newTextureData()
	 * @see com.jogamp.opengl.util.texture.spi.TextureProvider#newTextureData(com.jogamp.opengl.GLProfile, java.net.URL, int, int, boolean, java.lang.String)
	 */
	@Override
