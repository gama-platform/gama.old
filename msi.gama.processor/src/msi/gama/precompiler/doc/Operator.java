/*******************************************************************************************************
 *
 * Operator.java, in msi.gama.processor, is part of the source code of the GAMA modeling and simulation platform
 * (v.1.9.3).
 *
...
public class Operator implements IElement {
	 ...
	 *            the ops
	 */
	public void addOperands(final Operands ops) {
		combiIO.add(ops);
	}
	 ...
	 *            the see
	 */
	public void addSeeAlso(final String see) {
	 ...
	 *            the ex elt
	 */
	public void addUsage(final String descUsage, final org.w3c.dom.Element exElt) {
		if (exElt != null && exElt.hasChildNodes()) { has_example = true; }
	 ...
	 *            the desc usage
	 */
	public void addUsage(final String descUsage) {
	...
	public Element getElementDOM() {
		...
		if (has_example) { eltOp.setAttribute("HAS_TEST", "true"); }
		...
		for (Operands ops : combiIO) { combiElt.appendChild(ops.getElementDOM()); }
