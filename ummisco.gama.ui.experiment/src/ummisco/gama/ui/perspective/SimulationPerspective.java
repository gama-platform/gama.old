/*********************************************************************************************
 *
 * 'SimulationPerspective.java, in plugin ummisco.gama.ui.experiment, is part of the source code of the
...
public class SimulationPerspective implements IPerspectiveFactory {
	...
	public void createInitialLayout(final IPageLayout lay) {
		...
		final IPlaceholderFolderLayout displays = lay.createPlaceholderFolder("displays", IPageLayout.TOP, 0.7f,
				editor);
		displays.addPlaceholder(IGui.LAYER_VIEW_ID + ":*");
		displays.addPlaceholder(IGui.GL_LAYER_VIEW_ID + ":*");

		final IPlaceholderFolderLayout inspect = lay.createPlaceholderFolder("inspect", IPageLayout.RIGHT, 0.6f,
				"displays");
		inspect.addPlaceholder(IGui.AGENT_VIEW_ID);
		inspect.addPlaceholder(IGui.TABLE_VIEW_ID + ":*");

		final IPlaceholderFolderLayout monitor = lay.createPlaceholderFolder("monitor", IPageLayout.BOTTOM, 0.50f,
				"inspect");
