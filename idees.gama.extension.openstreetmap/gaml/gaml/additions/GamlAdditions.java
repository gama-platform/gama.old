...
_var(idees.gama.agents.OsmNodeAgent.class,desc(10,S(TYPE,"10",NAME,"signals_per_roads",CONST,FALSE)),null,null,null);
...
_var(idees.gama.agents.OsmNodeAgent.class,desc(5,S(TYPE,"5",NAME,"roads_out",CONST,FALSE,"of","11")),null,null,null);
_var(idees.gama.agents.OsmBuildingAgent.class,desc(4,S(TYPE,"4",NAME,"building",CONST,FALSE)),null,null,null);
_var(idees.gama.agents.OsmNodeAgent.class,desc(5,S(TYPE,"5",NAME,"roads_in",CONST,FALSE,"of","11")),null,null,null);
...
_var(idees.gama.agents.OsmTrafficSignalAgent.class,desc(4,S(TYPE,"4",NAME,"crossing",CONST,FALSE)),null,null,null);
_var(idees.gama.agents.OsmBuildingAgent.class,desc(3,S(TYPE,"3",NAME,"bridge",CONST,FALSE)),null,null,null);
_var(idees.gama.agents.OsmTrafficSignalAgent.class,desc(4,S(TYPE,"4",NAME,"highway",CONST,FALSE)),null,null,null);
_action("loadOSMFile",idees.gama.skills.OsmSkill.class,new GamaHelper(T(List.class), idees.gama.skills.OsmSkill.class){ @Override public List run(IScope s, IAgent a,ISkill t, Object... v){ return ((idees.gama.skills.OsmSkill) t).loadOSMFile(s); } },desc(PRIMITIVE, null, new ChildrenProvider(Arrays.asList(desc(ARG,NAME,"file"),desc(ARG,NAME,"road_species"),desc(ARG,NAME,"node_species"),desc(ARG,NAME,"building_species"),desc(ARG,NAME,"signal_species"),desc(ARG,NAME,"split_lines"))), NAME, "load_osm",TYPE, T(List.class).toString(), VIRTUAL,FALSE));
_skill("osm",idees.gama.skills.OsmSkill.class, new ISkillConstructor(){ @Override public ISkill newInstance(){return new idees.gama.skills.OsmSkill();}});
...
_species("osm_node",idees.gama.agents.OsmNodeAgent.class, new IAgentConstructor(){ @Override public IAgent createOneAgent(IPopulation p) {return new idees.gama.agents.OsmNodeAgent(p);}});
...
_species("osm_traffic_signal",idees.gama.agents.OsmTrafficSignalAgent.class, new IAgentConstructor(){ @Override public IAgent createOneAgent(IPopulation p) {return new idees.gama.agents.OsmTrafficSignalAgent(p);}});
	}
}