...
public class Clustering {
	...
	@operator(value = { "clustering_xmeans"},
		...
		public static IList<IList<IAgent>> primClusteringXMeans(final IScope scope,
				final IAddressableContainer<Integer, IAgent, Integer, IAgent> agents,IList<String> attributes, GamaMap<String, Object> parameters)
			throws GamaRuntimeException {
	...
	@operator(value = { "clustering_simple_kmeans"},
		...
		@doc(value = "A list of agent groups clustered by K-Means Algorithm based on the given attributes. Some paremeters can be defined: " +
			...
			examples = { @example(value = "clustering_simple_kmeans([ag1, ag2, ag3, ag4, ag5],[\"size\",\"age\", \"weight\"],[\"distance_f\"::\"manhattan\", \"num_clusters\"::3])",
				equals = "for example, can return [[ag1, ag3], [ag2], [ag4, ag5]]",
				isExecutable = false) }, see = { "clustering_xmeans", "clustering_em","clustering_farthestFirst","clustering_DBScan", "clustering_cobweb"})
		public static IList<IList<IAgent>> primClusteringSimpleKMeans(final IScope scope,
				final IAddressableContainer<Integer, IAgent, Integer, IAgent> agents,IList<String> attributes, GamaMap<String, Object> parameters) {
		...
		if (parameters != null) {
			try {
				...
				if (parameters.containsKey("dont_replace_missing_values")) {
					kmeans.setDontReplaceMissingValues(Cast.asBool(scope, parameters.get("dont_replace_missing_values")));
				}
				if (parameters.containsKey("max_iterations")) {
		...
		IList<IList<IAgent>> groupes = clusteringUsingWeka(scope, kmeans,
				attributes, agents);

		return groupes;
	}

	@operator(value = { "clustering_em"},
			content_type = IType.LIST,
			category = { IOperatorCategory.STATISTICAL})
		@doc(value = "A list of agent groups clustered by EM Algorithm based on the given attributes. Some paremeters can be defined: " +
			...
			examples = { @example(value = "clustering_em([ag1, ag2, ag3, ag4, ag5],[\"size\",\"age\", \"weight\"],[\"max_iterations\"::10, \"num_clusters\"::3])",
				equals = "for example, can return [[ag1, ag3], [ag2], [ag4, ag5]]",
				isExecutable = false) }, see = { "clustering_xmeans", "clustering_simple_kmeans","clustering_farthestFirst","clustering_DBScan", "clustering_cobweb"})
	
	public static IList<IList<IAgent>> primClusteringEM(final IScope scope,
			final IAddressableContainer<Integer, IAgent, Integer, IAgent> agents,IList<String> attributes, GamaMap<String, Object> parameters) {
		EM em = new EM();
	...
	@operator(value = { "clustering_farthestFirst"},
		...
		@doc(value = "A list of agent groups clustered by Farthest First Algorithm based on the given attributes. Some paremeters can be defined: " +
			...
			examples = { @example(value = "clustering_farthestFirst([ag1, ag2, ag3, ag4, ag5],[\"size\",\"age\", \"weight\"],[\"num_clusters\"::3])",
				equals = "for example, can return [[ag1, ag3], [ag2], [ag4, ag5]]",
				isExecutable = false) }, see = { "clustering_xmeans", "clustering_simple_kmeans","clustering_em","clustering_DBScan", "clustering_cobweb"})
	
	public static IList<IList<IAgent>> primClusteringFarthestFirst(final IScope scope,
			final IAddressableContainer<Integer, IAgent, Integer, IAgent> agents,IList<String> attributes, GamaMap<String, Object> parameters) {
	...
	@operator(value = { "clustering_DBScan"},
		...
		@doc(value = "A list of agent groups clustered by DBScan Algorithm based on the given attributes. Some paremeters can be defined: " +
			...
			examples = { @example(value = "clustering_DBScan([ag1, ag2, ag3, ag4, ag5],[\"size\",\"age\", \"weight\"],[\"distance_f\"::\"manhattan\"])",
				equals = "for example, can return [[ag1, ag3], [ag2], [ag4, ag5]]",
				isExecutable = false) }, see = { "clustering_xmeans", "clustering_em","clustering_farthestFirst","clustering_simple_kmeans", "clustering_cobweb"})
		public static IList<IList<IAgent>> primClusteringDBScan(final IScope scope,
				final IAddressableContainer<Integer, IAgent, Integer, IAgent> agents,IList<String> attributes, GamaMap<String, Object> parameters) {
		...
		IList<IList<IAgent>> groupes = clusteringUsingWeka(scope, dbScan,
				attributes, agents);
	...
	@operator(value = { "clustering_cobweb"},
		...
		@doc(value = "A list of agent groups clusteredby CobWeb Algorithm based on the given attributes. Some paremeters can be defined: " +
			...
			examples = { @example(value = "clustering_cobweb([ag1, ag2, ag3, ag4, ag5],[\"size\",\"age\", \"weight\"],[\"acuity\"::3.0, \"cutoff\"::0.5)",
				equals = "for example, can return [[ag1, ag3], [ag2], [ag4, ag5]]",
				isExecutable = false) }, see = { "clustering_xmeans", "clustering_em","clustering_farthestFirst","clustering_simple_kmeans", "clustering_cobweb"})
		public static IList<IList<IAgent>> primClusteringCobweb(final IScope scope,
				final IAddressableContainer<Integer, IAgent, Integer, IAgent> agents,IList<String> attributes, GamaMap<String, Object> parameters) {
		...
		IList<IList<IAgent>> groupes = clusteringUsingWeka(scope, cobweb,
				attributes, agents);
