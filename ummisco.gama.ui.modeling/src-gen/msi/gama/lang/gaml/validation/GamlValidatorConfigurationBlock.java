...
public class GamlValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {
	...
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(GamlConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	}
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("Gaml");
		if (section == null) {
			return dialogSettings.addNewSection("Gaml");
		}
		return section;
	}
}
