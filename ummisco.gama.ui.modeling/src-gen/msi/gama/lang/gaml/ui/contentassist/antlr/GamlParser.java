/*********************************************************************************************
 *
 * 'GamlParser.java, in plugin ummisco.gama.ui.modeling, is part of the source code of the
...
public class GamlParser extends AbstractPartialContentAssistParser {
	...
	@Inject GamlGrammarAccess grammarAccess;

	private Map<AbstractElement, String> nameMappings;

	@Override
	protected msi.gama.lang.gaml.ui.contentassist.antlr.internal.InternalGamlParser createParser() {
		final msi.gama.lang.gaml.ui.contentassist.antlr.internal.InternalGamlParser result = new msi.gama.lang.gaml.ui.contentassist.antlr.internal.InternalGamlParser(
				null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getS_ExperimentAccess().getNameAlternatives_2_0(),
							"rule__S_Experiment__NameAlternatives_2_0");
					put(grammarAccess.getS_ExperimentAccess().getAlternatives_4(),
					...
					put(grammarAccess.getS_1Expr_Facets_BlockOrEndAccess().getAlternatives_2(),
							"rule__S_1Expr_Facets_BlockOrEnd__Alternatives_2");
					put(grammarAccess.getS_1Expr_Facets_BlockOrEndAccess().getAlternatives_4(),
					...
					put(grammarAccess.getS_IfAccess().getElseAlternatives_4_1_0(),
					...
					put(grammarAccess.getS_DefinitionAccess().getNameAlternatives_2_0(),
							"rule__S_Definition__NameAlternatives_2_0");
					put(grammarAccess.getS_DefinitionAccess().getAlternatives_5(),
					...
					put(grammarAccess.getS_EquationAccess().getExprAlternatives_0_0(),
							"rule__S_Equation__ExprAlternatives_0_0");
					put(grammarAccess.getS_SolveAccess().getAlternatives_4(), "rule__S_Solve__Alternatives_4");
					put(grammarAccess.getS_DisplayAccess().getNameAlternatives_2_0(),
							"rule__S_Display__NameAlternatives_2_0");
					put(grammarAccess.getDisplayStatementAccess().getAlternatives(),
							"rule__DisplayStatement__Alternatives");
					put(grammarAccess.getSpeciesOrGridDisplayStatementAccess().getAlternatives_3(),
					...
					put(grammarAccess.get_1Expr_Facets_BlockOrEnd_KeyAccess().getAlternatives(),
					...
					put(grammarAccess.getDefinitionFacetKeyAccess().getAlternatives(),
					...
					put(grammarAccess.getSpecialFacetKeyAccess().getAlternatives(),
							"rule__SpecialFacetKey__Alternatives");
					put(grammarAccess.getActionFacetKeyAccess().getAlternatives(),
							"rule__ActionFacetKey__Alternatives");
					put(grammarAccess.getClassicFacetAccess().getAlternatives_0(),
							"rule__ClassicFacet__Alternatives_0");
					put(grammarAccess.getDefinitionFacetAccess().getNameAlternatives_1_0(),
							"rule__DefinitionFacet__NameAlternatives_1_0");
					put(grammarAccess.getFunctionFacetAccess().getAlternatives_0(),
					...
					put(grammarAccess.getArgumentPairAccess().getAlternatives_0_0(),
							"rule__ArgumentPair__Alternatives_0_0");
					put(grammarAccess.getArgumentPairAccess().getOpAlternatives_0_0_1_0_0(),
					...
					put(grammarAccess.getComparisonAccess().getOpAlternatives_1_0_1_0(),
							"rule__Comparison__OpAlternatives_1_0_1_0");
					put(grammarAccess.getAdditionAccess().getOpAlternatives_1_0_1_0(),
							"rule__Addition__OpAlternatives_1_0_1_0");
					put(grammarAccess.getMultiplicationAccess().getOpAlternatives_1_0_1_0(),
							"rule__Multiplication__OpAlternatives_1_0_1_0");
					put(grammarAccess.getUnitAccess().getOpAlternatives_1_0_1_0(),
					...
					put(grammarAccess.getUnaryAccess().getOpAlternatives_1_1_0_0_0(),
							"rule__Unary__OpAlternatives_1_1_0_0_0");
					put(grammarAccess.getUnaryAccess().getOpAlternatives_1_1_1_0_0(),
					...
					put(grammarAccess.getParameterAccess().getBuiltInFacetKeyAlternatives_1_0_0(),
					...
					put(grammarAccess.getGamlDefinitionAccess().getAlternatives(),
							"rule__GamlDefinition__Alternatives");
					put(grammarAccess.getEquationDefinitionAccess().getAlternatives(),
							"rule__EquationDefinition__Alternatives");
					put(grammarAccess.getTypeDefinitionAccess().getAlternatives(),
					...
					put(grammarAccess.getVarDefinitionAccess().getAlternatives_1(),
							"rule__VarDefinition__Alternatives_1");
					put(grammarAccess.getActionDefinitionAccess().getAlternatives(),
					...
					put(grammarAccess.getS_1Expr_Facets_BlockOrEndAccess().getGroup(),
					...
					put(grammarAccess.getS_DirectAssignmentAccess().getGroup_0(),
					...
					put(grammarAccess.getSpeciesOrGridDisplayStatementAccess().getGroup(),
					...
					put(grammarAccess.getArgumentDefinitionAccess().getGroup_2(),
					...
					put(grammarAccess.getActionFakeDefinitionAccess().getGroup(),
					...
					put(grammarAccess.getEquationFakeDefinitionAccess().getGroup(),
					...
					put(grammarAccess.getTerminalExpressionAccess().getGroup_5(),
							"rule__TerminalExpression__Group_5__0");
					put(grammarAccess.getStandaloneBlockAccess().getBlockAssignment_1(),
							"rule__StandaloneBlock__BlockAssignment_1");
					put(grammarAccess.getStringEvaluatorAccess().getTotoAssignment_0(),
							"rule__StringEvaluator__TotoAssignment_0");
					put(grammarAccess.getStringEvaluatorAccess().getExprAssignment_2(),
					...
					put(grammarAccess.getModelBlockAccess().getStatementsAssignment_1(),
					...
					put(grammarAccess.getS_GlobalAccess().getFacetsAssignment_1(),
							"rule__S_Global__FacetsAssignment_1");
					put(grammarAccess.getS_GlobalAccess().getBlockAssignment_2_0(),
					...
					put(grammarAccess.getS_SpeciesAccess().getFirstFacetAssignment_1(),
					...
					put(grammarAccess.getS_SpeciesAccess().getFacetsAssignment_3(),
							"rule__S_Species__FacetsAssignment_3");
					put(grammarAccess.getS_SpeciesAccess().getBlockAssignment_4_0(),
							"rule__S_Species__BlockAssignment_4_0");
					put(grammarAccess.getS_ExperimentAccess().getKeyAssignment_0(),
							"rule__S_Experiment__KeyAssignment_0");
					put(grammarAccess.getS_ExperimentAccess().getFirstFacetAssignment_1(),
							"rule__S_Experiment__FirstFacetAssignment_1");
					put(grammarAccess.getS_ExperimentAccess().getNameAssignment_2(),
							"rule__S_Experiment__NameAssignment_2");
					put(grammarAccess.getS_ExperimentAccess().getFacetsAssignment_3(),
							"rule__S_Experiment__FacetsAssignment_3");
					put(grammarAccess.getS_ExperimentAccess().getBlockAssignment_4_0(),
							"rule__S_Experiment__BlockAssignment_4_0");
					put(grammarAccess.getS_1Expr_Facets_BlockOrEndAccess().getKeyAssignment_0(),
							"rule__S_1Expr_Facets_BlockOrEnd__KeyAssignment_0");
					put(grammarAccess.getS_1Expr_Facets_BlockOrEndAccess().getFirstFacetAssignment_1(),
							"rule__S_1Expr_Facets_BlockOrEnd__FirstFacetAssignment_1");
					put(grammarAccess.getS_1Expr_Facets_BlockOrEndAccess().getExprAssignment_2_0(),
							"rule__S_1Expr_Facets_BlockOrEnd__ExprAssignment_2_0");
					put(grammarAccess.getS_1Expr_Facets_BlockOrEndAccess().getExprAssignment_2_1(),
							"rule__S_1Expr_Facets_BlockOrEnd__ExprAssignment_2_1");
					put(grammarAccess.getS_1Expr_Facets_BlockOrEndAccess().getFacetsAssignment_3(),
							"rule__S_1Expr_Facets_BlockOrEnd__FacetsAssignment_3");
					put(grammarAccess.getS_1Expr_Facets_BlockOrEndAccess().getBlockAssignment_4_0(),
					...
					put(grammarAccess.getS_DoAccess().getFirstFacetAssignment_1(),
					...
					put(grammarAccess.getS_IfAccess().getFirstFacetAssignment_1(),
					...
					put(grammarAccess.getS_ReflexAccess().getFirstFacetAssignment_1(),
					...
					put(grammarAccess.getS_ReflexAccess().getExprAssignment_3_2(),
					...
					put(grammarAccess.getS_DefinitionAccess().getTkeyAssignment_0(),
							"rule__S_Definition__TkeyAssignment_0");
					put(grammarAccess.getS_DefinitionAccess().getFirstFacetAssignment_1(),
							"rule__S_Definition__FirstFacetAssignment_1");
					put(grammarAccess.getS_DefinitionAccess().getNameAssignment_2(),
							"rule__S_Definition__NameAssignment_2");
					put(grammarAccess.getS_DefinitionAccess().getArgsAssignment_3_1(),
							"rule__S_Definition__ArgsAssignment_3_1");
					put(grammarAccess.getS_DefinitionAccess().getFacetsAssignment_4(),
							"rule__S_Definition__FacetsAssignment_4");
					put(grammarAccess.getS_DefinitionAccess().getBlockAssignment_5_0(),
					...
					put(grammarAccess.getS_ActionAccess().getFirstFacetAssignment_2(),
					...
					put(grammarAccess.getS_ActionAccess().getArgsAssignment_4_1(),
							"rule__S_Action__ArgsAssignment_4_1");
					put(grammarAccess.getS_ActionAccess().getFacetsAssignment_5(),
							"rule__S_Action__FacetsAssignment_5");
					put(grammarAccess.getS_ActionAccess().getBlockAssignment_6_0(),
							"rule__S_Action__BlockAssignment_6_0");
					put(grammarAccess.getS_VarAccess().getKeyAssignment_1(), "rule__S_Var__KeyAssignment_1");
					put(grammarAccess.getS_VarAccess().getFirstFacetAssignment_2(),
					...
					put(grammarAccess.getS_DirectAssignmentAccess().getExprAssignment_0_0(),
							"rule__S_DirectAssignment__ExprAssignment_0_0");
					put(grammarAccess.getS_DirectAssignmentAccess().getKeyAssignment_0_1(),
							"rule__S_DirectAssignment__KeyAssignment_0_1");
					put(grammarAccess.getS_DirectAssignmentAccess().getValueAssignment_0_2(),
							"rule__S_DirectAssignment__ValueAssignment_0_2");
					put(grammarAccess.getS_DirectAssignmentAccess().getFacetsAssignment_0_3(),
					...
					put(grammarAccess.getS_EquationsAccess().getKeyAssignment_0(),
							"rule__S_Equations__KeyAssignment_0");
					put(grammarAccess.getS_EquationsAccess().getNameAssignment_1(),
							"rule__S_Equations__NameAssignment_1");
					put(grammarAccess.getS_EquationsAccess().getFacetsAssignment_2(),
							"rule__S_Equations__FacetsAssignment_2");
					put(grammarAccess.getS_EquationsAccess().getEquationsAssignment_3_0_1_0(),
							"rule__S_Equations__EquationsAssignment_3_0_1_0");
					put(grammarAccess.getS_EquationAccess().getExprAssignment_0(),
					...
					put(grammarAccess.getS_SolveAccess().getBlockAssignment_4_0(),
					...
					put(grammarAccess.getS_DisplayAccess().getFirstFacetAssignment_1(),
					...
					put(grammarAccess.getS_DisplayAccess().getFacetsAssignment_3(),
							"rule__S_Display__FacetsAssignment_3");
					put(grammarAccess.getS_DisplayAccess().getBlockAssignment_4(),
							"rule__S_Display__BlockAssignment_4");
					put(grammarAccess.getDisplayBlockAccess().getStatementsAssignment_2(),
							"rule__DisplayBlock__StatementsAssignment_2");
					put(grammarAccess.getSpeciesOrGridDisplayStatementAccess().getKeyAssignment_0(),
							"rule__SpeciesOrGridDisplayStatement__KeyAssignment_0");
					put(grammarAccess.getSpeciesOrGridDisplayStatementAccess().getExprAssignment_1(),
							"rule__SpeciesOrGridDisplayStatement__ExprAssignment_1");
					put(grammarAccess.getSpeciesOrGridDisplayStatementAccess().getFacetsAssignment_2(),
							"rule__SpeciesOrGridDisplayStatement__FacetsAssignment_2");
					put(grammarAccess.getSpeciesOrGridDisplayStatementAccess().getBlockAssignment_3_0(),
							"rule__SpeciesOrGridDisplayStatement__BlockAssignment_3_0");
					put(grammarAccess.getParametersAccess().getParamsAssignment_1(),
							"rule__Parameters__ParamsAssignment_1");
					put(grammarAccess.getActionArgumentsAccess().getArgsAssignment_0(),
							"rule__ActionArguments__ArgsAssignment_0");
					put(grammarAccess.getActionArgumentsAccess().getArgsAssignment_1_1(),
							"rule__ActionArguments__ArgsAssignment_1_1");
					put(grammarAccess.getArgumentDefinitionAccess().getTypeAssignment_0(),
							"rule__ArgumentDefinition__TypeAssignment_0");
					put(grammarAccess.getArgumentDefinitionAccess().getNameAssignment_1(),
							"rule__ArgumentDefinition__NameAssignment_1");
					put(grammarAccess.getArgumentDefinitionAccess().getDefaultAssignment_2_1(),
							"rule__ArgumentDefinition__DefaultAssignment_2_1");
					put(grammarAccess.getClassicFacetAccess().getKeyAssignment_0_0(),
							"rule__ClassicFacet__KeyAssignment_0_0");
					put(grammarAccess.getClassicFacetAccess().getKeyAssignment_0_1(),
							"rule__ClassicFacet__KeyAssignment_0_1");
					put(grammarAccess.getClassicFacetAccess().getKeyAssignment_0_2(),
							"rule__ClassicFacet__KeyAssignment_0_2");
					put(grammarAccess.getClassicFacetAccess().getExprAssignment_1(),
							"rule__ClassicFacet__ExprAssignment_1");
					put(grammarAccess.getDefinitionFacetAccess().getKeyAssignment_0(),
							"rule__DefinitionFacet__KeyAssignment_0");
					put(grammarAccess.getDefinitionFacetAccess().getNameAssignment_1(),
							"rule__DefinitionFacet__NameAssignment_1");
					put(grammarAccess.getFunctionFacetAccess().getKeyAssignment_0_0(),
							"rule__FunctionFacet__KeyAssignment_0_0");
					put(grammarAccess.getFunctionFacetAccess().getKeyAssignment_0_1(),
							"rule__FunctionFacet__KeyAssignment_0_1");
					put(grammarAccess.getFunctionFacetAccess().getExprAssignment_2(),
					...
					put(grammarAccess.getTypeFacetAccess().getExprAssignment_1_0_0(),
							"rule__TypeFacet__ExprAssignment_1_0_0");
					put(grammarAccess.getTypeFacetAccess().getExprAssignment_1_1(),
							"rule__TypeFacet__ExprAssignment_1_1");
					put(grammarAccess.getActionFacetAccess().getKeyAssignment_0(),
							"rule__ActionFacet__KeyAssignment_0");
					put(grammarAccess.getActionFacetAccess().getExprAssignment_1_0(),
							"rule__ActionFacet__ExprAssignment_1_0");
					put(grammarAccess.getActionFacetAccess().getBlockAssignment_1_1(),
					...
					put(grammarAccess.getBlockAccess().getFunctionAssignment_2_0_0_0(),
							"rule__Block__FunctionAssignment_2_0_0_0");
					put(grammarAccess.getBlockAccess().getStatementsAssignment_2_1_0(),
							"rule__Block__StatementsAssignment_2_1_0");
					put(grammarAccess.getArgumentPairAccess().getOpAssignment_0_0_0_0(),
							"rule__ArgumentPair__OpAssignment_0_0_0_0");
					put(grammarAccess.getArgumentPairAccess().getOpAssignment_0_0_1_0(),
							"rule__ArgumentPair__OpAssignment_0_0_1_0");
					put(grammarAccess.getArgumentPairAccess().getRightAssignment_1(),
					...
					put(grammarAccess.getCastAccess().getRightAssignment_1_1_1_1(),
							"rule__Cast__RightAssignment_1_1_1_1");
					put(grammarAccess.getComparisonAccess().getOpAssignment_1_0_1(),
							"rule__Comparison__OpAssignment_1_0_1");
					put(grammarAccess.getComparisonAccess().getRightAssignment_1_1(),
							"rule__Comparison__RightAssignment_1_1");
					put(grammarAccess.getAdditionAccess().getOpAssignment_1_0_1(),
							"rule__Addition__OpAssignment_1_0_1");
					put(grammarAccess.getAdditionAccess().getRightAssignment_1_1(),
							"rule__Addition__RightAssignment_1_1");
					put(grammarAccess.getMultiplicationAccess().getOpAssignment_1_0_1(),
							"rule__Multiplication__OpAssignment_1_0_1");
					put(grammarAccess.getMultiplicationAccess().getRightAssignment_1_1(),
							"rule__Multiplication__RightAssignment_1_1");
					put(grammarAccess.getExponentiationAccess().getOpAssignment_1_0_1(),
							"rule__Exponentiation__OpAssignment_1_0_1");
					put(grammarAccess.getExponentiationAccess().getRightAssignment_1_1(),
					...
					put(grammarAccess.getUnaryAccess().getRightAssignment_1_1_0_1(),
					...
					put(grammarAccess.getUnaryAccess().getRightAssignment_1_1_1_1(),
							"rule__Unary__RightAssignment_1_1_1_1");
					put(grammarAccess.getAccessAccess().getOpAssignment_1_1_0_0(),
							"rule__Access__OpAssignment_1_1_0_0");
					put(grammarAccess.getAccessAccess().getArgsAssignment_1_1_0_1(),
							"rule__Access__ArgsAssignment_1_1_0_1");
					put(grammarAccess.getAccessAccess().getOpAssignment_1_1_1_0(),
							"rule__Access__OpAssignment_1_1_1_0");
					put(grammarAccess.getAccessAccess().getRightAssignment_1_1_1_1(),
							"rule__Access__RightAssignment_1_1_1_1");
					put(grammarAccess.getAccessAccess().getOpAssignment_1_1_2_0(),
							"rule__Access__OpAssignment_1_1_2_0");
					put(grammarAccess.getAccessAccess().getNamed_expAssignment_1_1_2_1(),
							"rule__Access__Named_expAssignment_1_1_2_1");
					put(grammarAccess.getPrimaryAccess().getParamsAssignment_3_2(),
							"rule__Primary__ParamsAssignment_3_2");
					put(grammarAccess.getPrimaryAccess().getExprsAssignment_4_2(),
					...
					put(grammarAccess.getPrimaryAccess().getRightAssignment_5_4(),
					...
					put(grammarAccess.getFunctionAccess().getActionAssignment_1(),
							"rule__Function__ActionAssignment_1");
					put(grammarAccess.getFunctionAccess().getParametersAssignment_3_0(),
							"rule__Function__ParametersAssignment_3_0");
					put(grammarAccess.getFunctionAccess().getArgsAssignment_3_1(),
							"rule__Function__ArgsAssignment_3_1");
					put(grammarAccess.getCastingFunctionAccess().getActionAssignment_0(),
							"rule__CastingFunction__ActionAssignment_0");
					put(grammarAccess.getCastingFunctionAccess().getTypeAssignment_1(),
							"rule__CastingFunction__TypeAssignment_1");
					put(grammarAccess.getCastingFunctionAccess().getArgsAssignment_3(),
							"rule__CastingFunction__ArgsAssignment_3");
					put(grammarAccess.getParameterAccess().getBuiltInFacetKeyAssignment_1_0(),
							"rule__Parameter__BuiltInFacetKeyAssignment_1_0");
					put(grammarAccess.getParameterAccess().getLeftAssignment_1_1_0(),
							"rule__Parameter__LeftAssignment_1_1_0");
					put(grammarAccess.getParameterAccess().getRightAssignment_2(),
							"rule__Parameter__RightAssignment_2");
					put(grammarAccess.getExpressionListAccess().getExprsAssignment_0(),
							"rule__ExpressionList__ExprsAssignment_0");
					put(grammarAccess.getExpressionListAccess().getExprsAssignment_1_1(),
							"rule__ExpressionList__ExprsAssignment_1_1");
					put(grammarAccess.getParameterListAccess().getExprsAssignment_0(),
							"rule__ParameterList__ExprsAssignment_0");
					put(grammarAccess.getParameterListAccess().getExprsAssignment_1_1(),
					...
					put(grammarAccess.getVariableRefAccess().getRefAssignment_1(),
							"rule__VariableRef__RefAssignment_1");
					put(grammarAccess.getTypeRefAccess().getRefAssignment_0_1_0(),
							"rule__TypeRef__RefAssignment_0_1_0");
					put(grammarAccess.getTypeRefAccess().getParameterAssignment_0_1_1(),
							"rule__TypeRef__ParameterAssignment_0_1_1");
					put(grammarAccess.getTypeRefAccess().getParameterAssignment_1_1_1(),
					...
					put(grammarAccess.getTypeInfoAccess().getSecondAssignment_2_1(),
					...
					put(grammarAccess.getEquationRefAccess().getRefAssignment_1(),
							"rule__EquationRef__RefAssignment_1");
					put(grammarAccess.getUnitFakeDefinitionAccess().getNameAssignment_1(),
							"rule__UnitFakeDefinition__NameAssignment_1");
					put(grammarAccess.getTypeFakeDefinitionAccess().getNameAssignment_1(),
							"rule__TypeFakeDefinition__NameAssignment_1");
					put(grammarAccess.getActionFakeDefinitionAccess().getNameAssignment_1(),
							"rule__ActionFakeDefinition__NameAssignment_1");
					put(grammarAccess.getSkillFakeDefinitionAccess().getNameAssignment_1(),
							"rule__SkillFakeDefinition__NameAssignment_1");
					put(grammarAccess.getVarFakeDefinitionAccess().getNameAssignment_1(),
							"rule__VarFakeDefinition__NameAssignment_1");
					put(grammarAccess.getEquationFakeDefinitionAccess().getNameAssignment_1(),
							"rule__EquationFakeDefinition__NameAssignment_1");
					put(grammarAccess.getTerminalExpressionAccess().getOpAssignment_0_1(),
							"rule__TerminalExpression__OpAssignment_0_1");
					put(grammarAccess.getTerminalExpressionAccess().getOpAssignment_1_1(),
							"rule__TerminalExpression__OpAssignment_1_1");
					put(grammarAccess.getTerminalExpressionAccess().getOpAssignment_2_1(),
							"rule__TerminalExpression__OpAssignment_2_1");
					put(grammarAccess.getTerminalExpressionAccess().getOpAssignment_3_1(),
							"rule__TerminalExpression__OpAssignment_3_1");
					put(grammarAccess.getTerminalExpressionAccess().getOpAssignment_4_1(),
							"rule__TerminalExpression__OpAssignment_4_1");
					put(grammarAccess.getTerminalExpressionAccess().getOpAssignment_5_1(),
	...
	protected Collection<FollowElement> getFollowElements(final AbstractInternalContentAssistParser parser) {
		try {
			final msi.gama.lang.gaml.ui.contentassist.antlr.internal.InternalGamlParser typedParser = (msi.gama.lang.gaml.ui.contentassist.antlr.internal.InternalGamlParser) parser;
