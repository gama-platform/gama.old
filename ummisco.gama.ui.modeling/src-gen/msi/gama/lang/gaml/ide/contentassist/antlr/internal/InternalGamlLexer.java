...
public class InternalGamlLexer extends Lexer {
    ...
    public final void mT__100() throws RecognitionException {
        try {
            int _type = T__100;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:96:8: ( 'action:' )
            // InternalGaml.g:96:10: 'action:'
            {
            match("action:"); 
    ...
    public final void mRULE_KEYWORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:17634:14: ( ( 'each' | 'self' | 'myself' | 'nil' | 'super' ) )
            // InternalGaml.g:17634:16: ( 'each' | 'self' | 'myself' | 'nil' | 'super' )
            {
            // InternalGaml.g:17634:16: ( 'each' | 'self' | 'myself' | 'nil' | 'super' )
            int alt1=5;
            switch ( input.LA(1) ) {
            ...
            switch (alt1) {
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // InternalGaml.g:17634:31: 'myself'
                    {
                    match("myself"); 
    ...
    public final void mRULE_INTEGER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:17636:14: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) )
            // InternalGaml.g:17636:16: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            {
            // InternalGaml.g:17636:16: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalGaml.g:17636:21: '1' .. '9' ( '0' .. '9' )*
                    {
                    matchRange('1','9'); 
                    // InternalGaml.g:17636:30: ( '0' .. '9' )*
                    loop2:
                    do {
                        int alt2=2;
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:17638:14: ( ( 'true' | 'false' ) )
            // InternalGaml.g:17638:16: ( 'true' | 'false' )
            {
            // InternalGaml.g:17638:16: ( 'true' | 'false' )
            int alt4=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:17640:9: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '0' .. '9' )* )
            // InternalGaml.g:17640:11: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '0' .. '9' )*
            {
            ...
            // InternalGaml.g:17640:39: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '0' .. '9' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_COLOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:17642:12: ( '#' ( '0' .. '9' | 'A' .. 'F' )+ )
            // InternalGaml.g:17642:14: '#' ( '0' .. '9' | 'A' .. 'F' )+
            {
            match('#'); 
            // InternalGaml.g:17642:18: ( '0' .. '9' | 'A' .. 'F' )+
            int cnt6=0;
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_DOUBLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:17644:13: ( ( '1' .. '9' ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '0' ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? ) )
            // InternalGaml.g:17644:15: ( '1' .. '9' ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '0' ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? )
            {
            // InternalGaml.g:17644:15: ( '1' .. '9' ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '0' ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? )
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    // InternalGaml.g:17644:16: '1' .. '9' ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    {
                    matchRange('1','9'); 
                    // InternalGaml.g:17644:25: ( '0' .. '9' )*
                    loop7:
                    do {
                        int alt7=2;
                    ...
                    switch (alt9) {
                        case 1 :
                            // InternalGaml.g:17644:38: '.' ( '0' .. '9' )+
                            {
                            match('.'); 
                            // InternalGaml.g:17644:42: ( '0' .. '9' )+
                            int cnt8=0;
                            loop8:
                            do {
                                int alt8=2;
                    ...
                    // InternalGaml.g:17644:56: ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    int alt12=2;
                    ...
                    switch (alt12) {
                        case 1 :
                            // InternalGaml.g:17644:57: ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+
                            {
                    ...
                    break;
                case 2 :
                    // InternalGaml.g:17644:92: '0' ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    {
                    match('0'); 
                    // InternalGaml.g:17644:96: ( '.' ( '0' .. '9' )+ )?
                    int alt14=2;
                    ...
                    switch (alt14) {
                        case 1 :
                            // InternalGaml.g:17644:97: '.' ( '0' .. '9' )+
                            {
                            match('.'); 
                            // InternalGaml.g:17644:101: ( '0' .. '9' )+
                            int cnt13=0;
                            loop13:
                            do {
                                int alt13=2;
                    ...
                    // InternalGaml.g:17644:115: ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    int alt17=2;
                    ...
                    switch (alt17) {
                        case 1 :
                            // InternalGaml.g:17644:116: ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+
                            {
                            if ( input.LA(1)=='E'||input.LA(1)=='e' ) {
                                input.consume();
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:17646:13: ( ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalGaml.g:17646:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalGaml.g:17646:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt21=2;
            ...
            switch (alt21) {
                case 1 :
                    // InternalGaml.g:17646:16: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalGaml.g:17646:20: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop19:
                    do {
                        int alt19=3;
                        ...
                        switch (alt19) {
                    	case 1 :
                    	    // InternalGaml.g:17646:21: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    ...
                    break;
                case 2 :
                    // InternalGaml.g:17646:81: '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalGaml.g:17646:86: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop20:
                    do {
                        int alt20=3;
                        ...
                        switch (alt20) {
                    	case 1 :
                    	    // InternalGaml.g:17646:87: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    	    if ( input.LA(1)=='\''||input.LA(1)=='\\'||input.LA(1)=='b'||input.LA(1)=='f'||input.LA(1)=='n'||input.LA(1)=='r'||(input.LA(1)>='t' && input.LA(1)<='u') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:17648:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalGaml.g:17648:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalGaml.g:17648:24: ( options {greedy=false; } : . )*
            loop22:
            do {
                int alt22=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:17650:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalGaml.g:17650:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalGaml.g:17650:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop23:
            do {
                int alt23=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:17652:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalGaml.g:17652:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalGaml.g:17652:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt26=0;
            loop26:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:17654:16: ( . )
            // InternalGaml.g:17654:18: .
            {
            matchAny(); 
    ...
    static final String DFA27_eotS =
        "\1\uffff\3\74\1\uffff\1\112\21\74\1\175\1\u0080\1\74\1\u0085\1\uffff\1\u0088\1\u008a\1\u008d\1\uffff\1\u008f\1\74\1\uffff\1\u0094\12\uffff\2\u00a0\1\uffff\2\64\2\uffff\7\74\1\uffff\10\74\2\uffff\1\u00b7\3\uffff\2\74\1\u00bf\20\74\1\u00d8\4\74\1\u00dd\5\74\1\u00e4\21\74\1\u00f7\5\uffff\3\74\15\uffff\1\74\17\uffff\1\u00a0\2\uffff\15\74\1\u010f\2\74\1\u0113\1\74\2\uffff\3\74\1\u0118\2\74\2\uffff\1\u011b\1\74\1\u011d\1\74\1\u011f\23\74\1\uffff\4\74\1\uffff\1\74\1\u013a\4\74\1\uffff\6\74\1\u0146\4\74\1\u014b\1\u014c\3\74\1\uffff\1\74\1\uffff\1\74\1\u0152\1\u0153\6\uffff\7\74\1\u015b\1\u0153\2\74\1\u015e\2\74\1\uffff\1\u0153\1\74\2\uffff\1\74\1\u0163\2\74\1\uffff\2\74\1\uffff\1\74\1\uffff\1\74\1\uffff\15\74\1\u0177\1\u0178\2\74\1\u017c\4\74\1\u0181\1\u0184\2\74\1\uffff\13\74\1\uffff\1\u0192\1\u0194\2\74\2\uffff\1\u0197\4\74\2\uffff\4\74\1\u01a0\1\u01a1\1\74\1\uffff\1\u01a3\1\74\1\uffff\2\74\1\u0153\1\74\1\uffff\14\74\1\u01b4\1\74\1\u01b6\1\u01b8\2\74\1\u01bb\2\uffff\2\74\2\uffff\1\u01bf\1\74\1\uffff\1\74\1\uffff\1\74\2\uffff\1\74\1\u01c5\2\74\1\u01c9\2\74\1\u01cd\2\74\1\u0197\1\74\1\u01d2\4\uffff\1\74\1\uffff\3\74\1\uffff\4\74\2\uffff\1\74\1\uffff\1\74\1\u01dd\1\u01de\1\uffff\1\74\1\u01e0\1\u01e1\1\u01e3\1\u01e4\1\u01e6\1\74\1\u01e8\1\u01e9\1\u01eb\1\74\1\u01ed\1\uffff\1\u01ee\3\uffff\2\74\1\uffff\1\74\1\u01f2\2\uffff\1\u01f3\1\u01f4\2\74\2\uffff\3\74\1\uffff\1\74\1\u0153\2\uffff\2\74\1\u01ff\2\uffff\11\74\1\u020a\2\uffff\1\74\7\uffff\1\u020c\2\uffff\1\74\1\uffff\1\u020e\2\uffff\2\74\1\u0211\3\uffff\1\74\1\u0214\1\74\1\uffff\5\74\2\uffff\2\74\1\u021d\2\74\1\u0221\3\74\2\uffff\1\u0225\4\uffff\1\74\1\uffff\1\u0227\1\74\1\uffff\3\74\1\uffff\1\74\1\u022e\1\74\1\u0230\1\uffff\2\74\2\uffff\1\74\1\u0234\1\74\1\uffff\1\74\1\uffff\2\74\1\u023a\1\74\1\u023c\1\u023d\3\uffff\2\74\1\u0240\1\uffff\1\74\1\uffff\2\74\2\uffff\1\74\3\uffff\1\74\1\uffff\5\74\1\uffff\1\74\1\u024c\3\74\1\uffff\1\u0250\1\u0251\1\74\2\uffff\3\74\1\u0256\1\uffff";
