	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getGamlLangDefAccess().getAlternatives_2(), "rule__GamlLangDef__Alternatives_2");
					put(grammarAccess.getDefKeywordAccess().getAlternatives_2(), "rule__DefKeyword__Alternatives_2");
					put(grammarAccess.getAbstractGamlRefAccess().getAlternatives(), "rule__AbstractGamlRef__Alternatives");
					put(grammarAccess.getStatementAccess().getAlternatives(), "rule__Statement__Alternatives");
					put(grammarAccess.getSubStatementAccess().getAlternatives(), "rule__SubStatement__Alternatives");
					put(grammarAccess.getSetEvalAccess().getAlternatives_3(), "rule__SetEval__Alternatives_3");
					put(grammarAccess.getDefinitionAccess().getAlternatives_3(), "rule__Definition__Alternatives_3");
					put(grammarAccess.getEvaluationAccess().getAlternatives_3(), "rule__Evaluation__Alternatives_3");
					...
					put(grammarAccess.getUnarOpAccess().getAlternatives(), "rule__UnarOp__Alternatives");
					put(grammarAccess.getPrePrimaryExprAccess().getAlternatives(), "rule__PrePrimaryExpr__Alternatives");
					put(grammarAccess.getPrimaryExpressionAccess().getAlternatives(), "rule__PrimaryExpression__Alternatives");
					put(grammarAccess.getAbrstractRefAccess().getAlternatives_1(), "rule__AbrstractRef__Alternatives_1");
					...
					put(grammarAccess.getGamlLangDefAccess().getGroup(), "rule__GamlLangDef__Group__0");
					put(grammarAccess.getDefKeywordAccess().getGroup(), "rule__DefKeyword__Group__0");
					put(grammarAccess.getGamlBlockAccess().getGroup(), "rule__GamlBlock__Group__0");
					put(grammarAccess.getGamlBlockAccess().getGroup_2(), "rule__GamlBlock__Group_2__0");
					put(grammarAccess.getGamlBlockAccess().getGroup_2_3(), "rule__GamlBlock__Group_2_3__0");
					put(grammarAccess.getGamlBlockAccess().getGroup_3(), "rule__GamlBlock__Group_3__0");
					put(grammarAccess.getGamlBlockAccess().getGroup_3_3(), "rule__GamlBlock__Group_3_3__0");
					put(grammarAccess.getDefFacetAccess().getGroup(), "rule__DefFacet__Group__0");
					put(grammarAccess.getDefFacetAccess().getGroup_2(), "rule__DefFacet__Group_2__0");
					put(grammarAccess.getDefFacetAccess().getGroup_3(), "rule__DefFacet__Group_3__0");
					...
					put(grammarAccess.getDefReservedAccess().getGroup_2(), "rule__DefReserved__Group_2__0");
					put(grammarAccess.getDefReservedAccess().getGroup_3(), "rule__DefReserved__Group_3__0");
					...
					put(grammarAccess.getGamlFacetRefAccess().getGroup(), "rule__GamlFacetRef__Group__0");
					...
					put(grammarAccess.getFacetExprAccess().getGroup_0(), "rule__FacetExpr__Group_0__0");
					put(grammarAccess.getFacetExprAccess().getGroup_1(), "rule__FacetExpr__Group_1__0");
					...
					put(grammarAccess.getAssignmentOpAccess().getGroup_1_0_2(), "rule__AssignmentOp__Group_1_0_2__0");
					put(grammarAccess.getAssignmentOpAccess().getGroup_1_0_3(), "rule__AssignmentOp__Group_1_0_3__0");
					...
					put(grammarAccess.getPairExprAccess().getGroup_1_0(), "rule__PairExpr__Group_1_0__0");
					...
					put(grammarAccess.getGamlBinExprAccess().getGroup(), "rule__GamlBinExpr__Group__0");
					put(grammarAccess.getGamlBinExprAccess().getGroup_1(), "rule__GamlBinExpr__Group_1__0");
					put(grammarAccess.getGamlBinExprAccess().getGroup_1_0(), "rule__GamlBinExpr__Group_1_0__0");
					...
					put(grammarAccess.getMatrixAccess().getGroup_1_1(), "rule__Matrix__Group_1_1__0");
					...
					put(grammarAccess.getRightMemberRefAccess().getGroup(), "rule__RightMemberRef__Group__0");
					put(grammarAccess.getRightMemberRefAccess().getGroup_1(), "rule__RightMemberRef__Group_1__0");
					put(grammarAccess.getAbrstractRefAccess().getGroup(), "rule__AbrstractRef__Group__0");
					put(grammarAccess.getAbrstractRefAccess().getGroup_1_0(), "rule__AbrstractRef__Group_1_0__0");
					put(grammarAccess.getAbrstractRefAccess().getGroup_1_0_2(), "rule__AbrstractRef__Group_1_0_2__0");
					put(grammarAccess.getAbrstractRefAccess().getGroup_1_0_2_1(), "rule__AbrstractRef__Group_1_0_2_1__0");
					put(grammarAccess.getAbrstractRefAccess().getGroup_1_1(), "rule__AbrstractRef__Group_1_1__0");
					put(grammarAccess.getAbrstractRefAccess().getGroup_1_1_2(), "rule__AbrstractRef__Group_1_1_2__0");
					put(grammarAccess.getAbrstractRefAccess().getGroup_1_1_2_1(), "rule__AbrstractRef__Group_1_1_2_1__0");
					...
					put(grammarAccess.getModelAccess().getGamlAssignment_3(), "rule__Model__GamlAssignment_3");
					put(grammarAccess.getModelAccess().getStatementsAssignment_4(), "rule__Model__StatementsAssignment_4");
					put(grammarAccess.getImportAccess().getImportURIAssignment_1(), "rule__Import__ImportURIAssignment_1");
					put(grammarAccess.getGamlLangDefAccess().getKAssignment_2_0(), "rule__GamlLangDef__KAssignment_2_0");
					put(grammarAccess.getGamlLangDefAccess().getFAssignment_2_1(), "rule__GamlLangDef__FAssignment_2_1");
					put(grammarAccess.getGamlLangDefAccess().getBAssignment_2_2(), "rule__GamlLangDef__BAssignment_2_2");
					put(grammarAccess.getGamlLangDefAccess().getRAssignment_2_3(), "rule__GamlLangDef__RAssignment_2_3");
					put(grammarAccess.getGamlLangDefAccess().getUAssignment_2_4(), "rule__GamlLangDef__UAssignment_2_4");
					put(grammarAccess.getDefKeywordAccess().getNameAssignment_1(), "rule__DefKeyword__NameAssignment_1");
					put(grammarAccess.getDefKeywordAccess().getBlockAssignment_2_0(), "rule__DefKeyword__BlockAssignment_2_0");
					put(grammarAccess.getGamlBlockAccess().getFacetsAssignment_2_2(), "rule__GamlBlock__FacetsAssignment_2_2");
					put(grammarAccess.getGamlBlockAccess().getFacetsAssignment_2_3_1(), "rule__GamlBlock__FacetsAssignment_2_3_1");
					put(grammarAccess.getGamlBlockAccess().getChildsAssignment_3_2(), "rule__GamlBlock__ChildsAssignment_3_2");
					put(grammarAccess.getGamlBlockAccess().getChildsAssignment_3_3_1(), "rule__GamlBlock__ChildsAssignment_3_3_1");
					put(grammarAccess.getDefFacetAccess().getNameAssignment_1(), "rule__DefFacet__NameAssignment_1");
					put(grammarAccess.getDefFacetAccess().getTypeAssignment_2_1(), "rule__DefFacet__TypeAssignment_2_1");
					put(grammarAccess.getDefFacetAccess().getDefaultAssignment_3_1(), "rule__DefFacet__DefaultAssignment_3_1");
					...
					put(grammarAccess.getDefReservedAccess().getTypeAssignment_2_1(), "rule__DefReserved__TypeAssignment_2_1");
					put(grammarAccess.getDefReservedAccess().getValueAssignment_3_1(), "rule__DefReserved__ValueAssignment_3_1");
					put(grammarAccess.getDefUnitAccess().getNameAssignment_1(), "rule__DefUnit__NameAssignment_1");
					put(grammarAccess.getDefUnitAccess().getCoefAssignment_2_1(), "rule__DefUnit__CoefAssignment_2_1");
					put(grammarAccess.getGamlKeywordRefAccess().getRefAssignment(), "rule__GamlKeywordRef__RefAssignment");
					put(grammarAccess.getGamlFacetRefAccess().getRefAssignment_0(), "rule__GamlFacetRef__RefAssignment_0");
					put(grammarAccess.getGamlBinarOpRefAccess().getRefAssignment(), "rule__GamlBinarOpRef__RefAssignment");
					put(grammarAccess.getGamlUnitRefAccess().getRefAssignment(), "rule__GamlUnitRef__RefAssignment");
					put(grammarAccess.getGamlReservedRefAccess().getRefAssignment(), "rule__GamlReservedRef__RefAssignment");
					put(grammarAccess.getSetEvalAccess().getVarAssignment_1(), "rule__SetEval__VarAssignment_1");
					put(grammarAccess.getSetEvalAccess().getFacetsAssignment_2(), "rule__SetEval__FacetsAssignment_2");
					put(grammarAccess.getSetEvalAccess().getBlockAssignment_3_0(), "rule__SetEval__BlockAssignment_3_0");
					...
					put(grammarAccess.getEvaluationAccess().getKeyAssignment_0(), "rule__Evaluation__KeyAssignment_0");
					put(grammarAccess.getEvaluationAccess().getVarAssignment_1_1(), "rule__Evaluation__VarAssignment_1_1");
					put(grammarAccess.getEvaluationAccess().getFacetsAssignment_2(), "rule__Evaluation__FacetsAssignment_2");
					put(grammarAccess.getEvaluationAccess().getBlockAssignment_3_0(), "rule__Evaluation__BlockAssignment_3_0");
					put(grammarAccess.getFacetExprAccess().getNameAssignment_0_1(), "rule__FacetExpr__NameAssignment_0_1");
					put(grammarAccess.getFacetExprAccess().getKeyAssignment_1_0(), "rule__FacetExpr__KeyAssignment_1_0");
					put(grammarAccess.getFacetExprAccess().getExprAssignment_1_1(), "rule__FacetExpr__ExprAssignment_1_1");
					...
					put(grammarAccess.getTernExpAccess().getIfTrueAssignment_1_2(), "rule__TernExp__IfTrueAssignment_1_2");
					...
					put(grammarAccess.getPairExprAccess().getRightAssignment_1_1(), "rule__PairExpr__RightAssignment_1_1");
					...
					put(grammarAccess.getGamlBinExprAccess().getOpAssignment_1_0_1(), "rule__GamlBinExpr__OpAssignment_1_0_1");
					put(grammarAccess.getGamlBinExprAccess().getRightAssignment_1_1(), "rule__GamlBinExpr__RightAssignment_1_1");
					...
					put(grammarAccess.getGamlUnaryExprAccess().getOpAssignment_1_1_0(), "rule__GamlUnaryExpr__OpAssignment_1_1_0");
					put(grammarAccess.getGamlUnaryExprAccess().getRightAssignment_1_1_1(), "rule__GamlUnaryExpr__RightAssignment_1_1_1");
					...
					put(grammarAccess.getMatrixAccess().getRowsAssignment_1_0(), "rule__Matrix__RowsAssignment_1_0");
					put(grammarAccess.getMatrixAccess().getRowsAssignment_1_1_1(), "rule__Matrix__RowsAssignment_1_1_1");
					put(grammarAccess.getRowAccess().getExprsAssignment_0(), "rule__Row__ExprsAssignment_0");
					put(grammarAccess.getRowAccess().getExprsAssignment_1_1(), "rule__Row__ExprsAssignment_1_1");
					put(grammarAccess.getRightMemberRefAccess().getRightAssignment_1_2(), "rule__RightMemberRef__RightAssignment_1_2");
					put(grammarAccess.getAbrstractRefAccess().getArgsAssignment_1_0_2_0(), "rule__AbrstractRef__ArgsAssignment_1_0_2_0");
					put(grammarAccess.getAbrstractRefAccess().getArgsAssignment_1_0_2_1_1(), "rule__AbrstractRef__ArgsAssignment_1_0_2_1_1");
					put(grammarAccess.getAbrstractRefAccess().getArgsAssignment_1_1_2_0(), "rule__AbrstractRef__ArgsAssignment_1_1_2_0");
					put(grammarAccess.getAbrstractRefAccess().getArgsAssignment_1_1_2_1_1(), "rule__AbrstractRef__ArgsAssignment_1_1_2_1_1");
