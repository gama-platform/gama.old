		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDefinitionAccess().getNameAlternatives_1_0(), "rule__Definition__NameAlternatives_1_0");
					...
					put(grammarAccess.getNameFacetExprAccess().getNameAlternatives_1_0(), "rule__NameFacetExpr__NameAlternatives_1_0");
					put(grammarAccess.getActionFacetExprAccess().getNameAlternatives_1_0(), "rule__ActionFacetExpr__NameAlternatives_1_0");
					...
					put(grammarAccess.getPrimaryExpressionAccess().getGroup_3_2_3(), "rule__PrimaryExpression__Group_3_2_3__0");
					...
					put(grammarAccess.getNameFacetExprAccess().getNameAssignment_1(), "rule__NameFacetExpr__NameAssignment_1");
					put(grammarAccess.getReturnsFacetExprAccess().getNameAssignment_1(), "rule__ReturnsFacetExpr__NameAssignment_1");
					put(grammarAccess.getActionFacetExprAccess().getNameAssignment_1(), "rule__ActionFacetExpr__NameAssignment_1");
					...
					put(grammarAccess.getPrimaryExpressionAccess().getZAssignment_3_2_3_1(), "rule__PrimaryExpression__ZAssignment_3_2_3_1");
