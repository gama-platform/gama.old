		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPairExprAccess().getOpAssignment_1_0_1(), "rule__PairExpr__OpAssignment_1_0_1");
					...
					put(grammarAccess.getMultiplicationAccess().getOpAssignment_1_0_2_1(), "rule__Multiplication__OpAssignment_1_0_2_1");
