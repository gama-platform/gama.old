...
public class GamlOutlineTreeProvider extends DefaultOutlineTreeProvider {
	...
	protected void _createChildren(final IOutlineNode parentNode, final Model stm) {
		...
		if ( block != null ) {
			for ( Statement s : EGaml.getStatementsOf(block) ) {
				if ( s instanceof S_Global || s instanceof S_Environment || s instanceof S_Entities ) {
					block = s.getBlock();
					if ( block != null ) {
	...
	// protected void _createChildren(final IOutlineNode parentNode, final S_Global stm) {
	// Block block = stm.getBlock();
	// if ( block != null ) {
	...
	// protected void _createNode(final IOutlineNode parentNode, final Parameter stm) {
	//
	// }
	...
	protected void _createNode(final IOutlineNode parentNode, final S_Entities stm) {
		//
	}

	protected void _createNode(final IOutlineNode parentNode, final S_Environment stm) {
		//
	}
