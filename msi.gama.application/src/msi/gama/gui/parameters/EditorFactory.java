...
public class EditorFactory implements IEditorFactory {
	...
	//
	// private static GenericEditor createGeneric(final Composite parent, final String title, final Object value,
	...
	public AbstractEditor create(final IScope scope, final IAgent agent, final IParameter var, final EditorListener l) {
		...
		if ( t.isContainer() &&
			t.getContentType().isAgentType() ) { return new PopulationEditor(scope, agent, var, l); }
