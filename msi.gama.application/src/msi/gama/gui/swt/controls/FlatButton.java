...
public class FlatButton extends CLabel implements /* PaintListener, */Listener {
	...
	public static FlatButton
		...
		FlatButton button = button(comp, color, text);
		button.setImage(image);
		return button;
	}

	public static FlatButton menu(final Composite comp, final GamaUIColor color, final String text) {
		FlatButton button = button(comp, color, text)/* .setImageStyle(IMAGE_RIGHT) */;
