 ...
 * <ul>
 *   <li>{@link gama.impl.EGraphImpl#getNode <em>Node</em>}</li>
 *   <li>{@link gama.impl.EGraphImpl#getEdge <em>Edge</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EGraphImpl extends EGamaObjectImpl implements EGraph {
	/**
	...
	protected EClass eStaticClass() {
		return GamaPackage.Literals.EGRAPH;
	}
		...
		if (node != null && node.eIsProxy()) {
			...
			if (node != oldNode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GamaPackage.EGRAPH__NODE, oldNode, node));
			}
		}
		return node;
	}
	...
	public void setNode(ESpecies newNode) {
		...
		node = newNode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GamaPackage.EGRAPH__NODE, oldNode, node));
	}
	...
	public ESpecies getEdge() {
		if (edge != null && edge.eIsProxy()) {
			...
			if (edge != oldEdge) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GamaPackage.EGRAPH__EDGE, oldEdge, edge));
			}
		}
		return edge;
	}
	...
	public void setEdge(ESpecies newEdge) {
		...
		edge = newEdge;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GamaPackage.EGRAPH__EDGE, oldEdge, edge));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GamaPackage.EGRAPH__NODE:
				if (resolve) return getNode();
				return basicGetNode();
			case GamaPackage.EGRAPH__EDGE:
