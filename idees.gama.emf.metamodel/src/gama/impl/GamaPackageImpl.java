...
public class GamaPackageImpl extends EPackageImpl implements GamaPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getEGridTopology_Nb_columns(), ecorePackage.getEString(), "nb_columns", null, 0, 1, EGridTopology.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEGridTopology_Nb_rows(), ecorePackage.getEString(), "nb_rows", null, 0, 1, EGridTopology.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEGridTopology_Neighbourhood(), ecorePackage.getEString(), "neighbourhood", null, 0, 1, EGridTopology.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
