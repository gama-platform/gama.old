...
global {
	...
	init {
		...
		save pedestrian_path to: "../includes/pedestrian paths.shp";
		save open_area to: "../includes/open area.shp";
		save pedestrian_path collect each.free_space to: "../includes/free spaces.shp";
	}
}
