...
//D√©finition des lois pour cr√©er des obligations sur le mod√®le des r√™gles d'inf√©rences avec en suppl√©ment un seuil d'ob√©issance
						...
						if (newObligation != null) {
							if (allVal) {
								for (Predicate p : predBeliefList) {
									...
									//ne faire ces actions que si on n'a pas dÈj‡ l'obligation
